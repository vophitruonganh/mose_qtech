...
{{--=========================== SIDEBAR CUA HANG =========================== --}}
    ...
    @show
{{-- =========================== END SIDEBAR CUA HANG =========================== --}}

{{-- =========================== SIDEBAR WEBSITE =========================== --}}
    @section('sitebar-website')
        ...
        <li class="{{ (Request::is('admin/template*') ? 'opened' : '') }}">
        ...
        <li class="{{ (Request::is('admin/setting/domains') ? 'opened' : '') }}">
            <a href="{{ url('admin/setting/domains') }}">
