...
?>
    <div class="section-product">
        ...
        <form id="product-form" action="{{ url('admin/product/create') }}" method="post" data-bind="form: disable">
                ...
                <div class="box-container-1">
                    <div class="box-typical b-t-p b-t-m">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control meta-title" id="title" name="title" value="{{ old('title') }}" />
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea rows="3" class="form-control meta-description" name="excerpt">{{ old('excerpt') }}</textarea>
                    ...
                    <div class="box-typical b-t-p b-t-m">
                        <div class="box-heading box-heading-action">
                            ...
                            <div class="heading-action">
                                ...
                                <button type="button" class="btn btn-link m-l-1" data-bind="click: Modal.LoadImage"><i class="material-icons md-18">add_a_photo</i> Chọn hình</button>
                            </div>
                        </div>
                        <div class="box-body">
                    ...
                    <div class="box-typical box-typical-margin">
                        <div class="box-heading box-heading-padding">
                            <h3 class="heading-text">Thông tin sản phẩm</h3>
                        </div>
                        <div class="box-body box-body-padding p-t-0">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" id="price-new" name="price_new" value="{{ old('price_new') }}" data-bind="keyup: Format.Number, keyup: Variant.SetValue" data-value="price" />
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" id="price_old" name="price_old" value="{{ old('price_old') }}" data-bind="keyup: Format.Number" />
                                            <span class="input-group-addon">&#8363;</span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="product-sku" class="form-control" name="sku" value="{{ old('sku')}}" data-bind="keyup: Variant.SetValue" data-value="sku" />
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Mã vạch / Barcode</label>
                                        <input type="text" id="product-barcode" class="form-control" name="barcode" value="{{ old('barcode')}}" data-bind="keyup: Variant.SetValue" data-value="barcode" />
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" id="product-weight" name="product_weight" value="{{ old('product_weight') }}" data-bind="keyup: Format.Number" />
                            ...
                            <div class="form-inline">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control" id="product-quantity" name="product_quantity" value="{{ old('product_quantity') }}" placeholder="Số lượng" readonly="readonly" data-bind="keyup: Format.Integer, keyup: Variant.SetValue" data-value="quantity" />
                                </div>
                            ...
                            <div class="misc-actions">
                                ...
                                <div class="misc-group">
                                    <div class="inner" data-toggle="collapse" data-target="#misc-product-date" aria-expanded="false" aria-controls="misc-product-date">
                                        ...
                                        <label class="misc-label-text m-b-0" data-bind="text: product_date">{{ old('product_date',date('H:i d/m/Y',time()))}}</label>
                                        <i class="font-icon material-icons">mode_edit</i>
                                    </div>
                                    <div id="misc-product-date" class="form-inline collapse extend">
                                        <div class="form-group">
                                            <input type="text" name="product_date" class="form-control" data-plugin="datetimepicker" value="{{ old('product_date',date('H:i d/m/Y',time()))}}" placeholder="Ngày tạo" data-model="product_date" />
                                        </div>
                                ...
                                <div class="misc-group">
                                    <div class="inner" data-toggle="collapse" data-target="#misc-product-comment" aria-expanded="false" aria-controls="misc-product-comment">
                                        ...
                                        <i class="font-icon material-icons">mode_edit</i>
                                        <input type="hidden" name="hidden_product_comment" id="hidden_product_comment" value="{{old('product_comment','yes')}}">
                                    </div>
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdown-product-group">
                                        ...
                                        <ul>
                                            ...
                                            <li><a class="dropdown-item" href="javascript:;" data-id="{{$product_group->taxonomy_id}}"><span>{{$product_group->taxonomy_name}}</span><i class="font-icon material-icons md-18">check</i></a></li>
                                             @endforeach()
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdown-product-vendor">
                                        ...
                                        <ul>
                                            ...
                                            <li><a class="dropdown-item" href="javascript:;" data-id="{{$product_vendor->taxonomy_id}}"><span>{{$product_vendor->taxonomy_name}}</span><i class="font-icon material-icons md-18">check</i></a></li>
                                             @endforeach()
                                        </ul>
                                    </div>
                                </div>
    ...
    <div id="modal-urlimage" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="{{ url('admin/attachment/upload-from-url') }}" method="post" data-bind="form: disable">
