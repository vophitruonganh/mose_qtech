                        ...
                        <div class="pull-md-left">
                            <div class="form-group">
                                <select name="order_status" id="action_status" class="form-control" data-bind="change: Table.ActionChange, change: Table.StatusChange">
                                    ...
                                    @if($order_count['trash'] > 0)<option @if($order_status =='4')selected="selected" @endif  value="4" data-url="{{url('admin/order?order_status=4')}}">Xóa <span class="count">({{$order_count['trash']}})</span></option>@endif
                                </select>
                            </div>
                              <?php
                                $arr=array();
