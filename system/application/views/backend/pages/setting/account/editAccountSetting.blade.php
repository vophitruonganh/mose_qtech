                    ...
                    <div class="section-group-body col-lg-9">
                        <div class="box-typical b-t-p">
                            <div class="form-group">
                                ...
                                <input id="username" class="form-control" name="username" type="text" value="{{ old('username',$user->user_username) }}" minlength="6" maxlength="30" data-parsley-trigger="change focusout" data-parsley-length="[6, 30]" data-parsley-length-message="Vui lòng sử dụng từ 6 đến 30 ký tự." />
                                <small class="text-muted">Nếu để trống bạn có thể sử dụng email để đăng nhập</small>
                            </div>
                            <div class="form-group">
                                <label for="email">Email</label>
                                <input id="email" class="form-control" name="email" type="text" value="{{ old('email',$user->user_email) }}" required maxlength="60" data-parsley-trigger="change focusout" data-parsley-required="true" data-parsley-required-message="Bạn không được để trống trường này" data-parsley-type="email" data-parsley-type-message="Địa chỉ Email không không hợp lệ" data-parsley-maxlength="60" data-parsley-maxlength-message="Địa chỉ Email quá dài." />
