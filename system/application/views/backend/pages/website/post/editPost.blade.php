...
@section('titlePage','Chỉnh sửa bài viết')
@section('content')
<?php 
    $heading = array(
...
?>
    <div class="section-post">
        ...
        <form id="post-form" action="{{ url('admin/post/edit/'.$post->post_id) }}" method="post" data-bind="form: disable">
                ...
                <div class="box-container-1">
                    <div class="box-typical b-t-p b-t-m">
                        ...
                        <div class="form-group m-b-0">
                            <label>Mô tả</label>
                            <textarea class="form-control meta-description" rows="3" name="excerpt">{{old('excerpt',$post->post_excerpt)}}</textarea>
                    ...
                    <div class="box-typical">
                        <div class="proj-page-section proj-page-action clearfix">
                            <div class="pull-xs-right">
                                <a class="btn btn-link text-danger" href="{{ url('admin/post/trash/'.$post->post_id) }}">Xóa bài viết</a>
                        ...
                        <div class="proj-page-section proj-page-info">
                            ...
                            <div class="misc-actions">
                                ...
                                <div class="misc-group">
                                    ...
                                    <label class="misc-label-text m-b-0"><a href="{{url('admin/post?user_id='.$post->user_id)}}">@if( strlen($post->user_fullname) > 0 ) {{ $post->user_fullname }} @else {{ $post->user_email }} @endif </a> </label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="proj-page-section">
                            ...
                            <div id="post-tags" class="tags-choose">
                                <div class="form-group">
                                    <input type="text" name="newtags" data-plugin="tagsinput" class="form-control" value="{{$tag_name}}" placeholder="Nhập nhãn bài viết" />
                                </div>
                            </div>
                        </div>
