 ...
 <div id="partners" class="home-section wow zoomIn">
    <div class="fix-width">
       <div class="section-header">
          <h3 class="section-title">{{ $partner['heading'] }}</h3>
       </div>
...
<footer class="footer">
         <div class="footer-wrapper fix-width">
            <!-- Begin footer navigation -->
              <div class="widget menu-footer">
               ...
               <ul class="menu">
                  <li><a href="{{url('collections?search=')}}" title="Tìm kiếm">Tìm kiếm</a></li>
                  <li><a href="{{url('pages/gioi-thieu')}}" title="Giới thiệu">Giới thiệu</a></li>
                  ...
                  <li><a href="{{url('post')}}" title="Tin Tức">Tin Tức</a></li>
                  <li><a href="{{url('pages/contact')}}" title="Liên Hệ">Liên Hệ</a></li>
               </ul>
            </div>
            ...
            <div class="socials widget">
               ...
               <div class="content-socials">
                  <div class="fb-page" data-href="{{ $facebook['url'] }}" data-small-header="false" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true" data-show-posts="false">
                     <div class="fb-xfbml-parse-ignore">
                        <blockquote cite="{{ $facebook['url'] }}"><a href="{{ $facebook['url'] }}">Qm-Tech</a></blockquote>
                     </div>
                  </div>
      ...
      <script src="{{ asset('template/giaodien9/asset/js/owl.carousel.min.js?v=583') }}" type='text/javascript'></script>
      <script src="{{ asset('template/giaodien9/asset/js/wow.js?v=583') }}" type='text/javascript'></script>
      <script src="{{ asset('template/giaodien9/asset/js/jquery.zoom.js?v=583') }}" type='text/javascript'></script>
      <script src="{{ asset('template/giaodien9/asset/js/jquery.tweet.js?v=583') }}" type='text/javascript'></script>
      <script src="{{ asset('template/giaodien9/asset/js/jquery.fancybox.js?v=583') }}" type='text/javascript'></script>
   </body>
</html>
<!-- End Footer -->