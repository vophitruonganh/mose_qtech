        ...
        <div class="photo-stream-widget">
          <div class="flickr_badge">
            <div class="flickr_badge_image">
              <a href="#"><img src="{{ asset('template/decima_store/images/content/flickr-01.jpg') }}" alt=" "></a>
            </div>
            <div class="flickr_badge_image">
              <a href="#"><img src="{{ asset('template/decima_store/images/content/flickr-02.jpg') }}" alt=" "></a>
            </div>
            <div class="flickr_badge_image">
              <a href="#"><img src="{{ asset('template/decima_store/images/content/flickr-03.jpg') }}" alt=" "></a>
            </div>
            <div class="flickr_badge_image">
              <a href="#"><img src="{{ asset('template/decima_store/images/content/flickr-04.jpg') }}" alt=" "></a>
            </div>
            <div class="flickr_badge_image">
              <a href="#"><img src="{{ asset('template/decima_store/images/content/flickr-05.jpg') }}" alt=" "></a>
            </div>
            <div class="flickr_badge_image">
              <a href="#"><img src="{{ asset('template/decima_store/images/content/flickr-06.jpg') }}" alt=" "></a>
            </div>
          </div>
        </div>
      </div>
...
<script src="{{ asset('template/decima_store/bootstrap/js/bootstrap.min.js') }}"></script>

<!-- !core -->

<!-- plugins -->
<script src="{{ asset('template/decima_store/js/jquery.flexslider-min.js') }}"></script>

<script src="{{ asset('template/decima_store/js/jquery.isotope.min.js') }}"></script>
<script src="{{ asset('template/decima_store/js/jquery.ba-bbq.min.js') }}"></script>

<script src="{{ asset('template/decima_store/js/jquery-ui-1.10.3.custom.min.js') }}"></script>

<script src="{{ asset('template/decima_store/js/jquery.raty.min.js') }}"></script>

<script src="{{ asset('template/decima_store/js/jquery.prettyPhoto.js') }}"></script>

<script src="{{ asset('template/decima_store/js/chosen.jquery.min.js') }}"></script>
<script src="{{ asset('template/decima_store/form/js/contact-form.js') }}"></script>
<script src="{{ asset('template/decima_store/twitter/js/jquery.tweet.js') }}"></script>
<!-- !plugins -->

<script src="{{ asset('template/decima_store/js/main.js') }}"></script>
