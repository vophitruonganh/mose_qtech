                          ...
                          <div class="list-service col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <div class="ourservice-block">
                              <div class="media">
                                ...
                                <h4 class="ourservice-heading ">{{ $row['heading'] }}</h4>
                                <div class="ourservice-content">{{ $row['content'] }}</div>
                              </div>
                            </div>
                          </div>
                          @endforeach
                     ...
                     <div class="row">
                        <div class="footer-links clearfix">
                           <div class="footer-block col-lg-2 col-sm-2 col-md-2 col-xs-12">
                              <h4 class="footer-static-title">{{ $links['heading'] }}</h4>
                              <div class="block_content toggle-footer" style="">
                                 <ul class="bullet">
                                    <?php unset($links['heading']); ?>
                                    @foreach( $links as $row )
                                    <li><a href="{{ $row['url'] }}" title="{{ $row['title'] }}">{{ $row['title'] }}</a></li>
                                    @endforeach
                                 </ul>
                              </div>
                           </div>
                           <div class="footer-block col-lg-2 col-sm-2 col-md-2 col-xs-12">
                              <h4 class="footer-static-title">{{ $support['heading'] }}</h4>
                              <div class="block_content toggle-footer" style="">
                                 <ul class="bullet">
                           ...
                           <div class="footer-block col-lg-2 col-sm-2 col-md-2 col-xs-12">
                              <h4 class="footer-static-title">{{ $service_menu['heading'] }}</h4>
                              <div class="block_content toggle-footer" style="">
                                 <ul class="bullet">
                           ...
                           <div class="footer-block col-contact col-lg-3 col-sm-3 col-md-3 col-xs-12">
                              <div class="contact-footer">
                                 <p class="phone">{{ $storeSetting['telephone'] }}</p>
                                 <!-- <span class="time-normal" style="">Thứ 2 - Thứ 6: 8:00-</span> -->
                                 <p class="marker-first"><i class="fa fa-map-marker"></i> {{ $storeSetting['address'] }}</p>
                                 <p><i class="fa fa-envelope-o"></i>{{ $storeSetting['email'] }}</p>
                              </div>
                              <div id="icon-footer">
                                @foreach( $social as $row )
                                <a class="_blank" href="{{ $row['url'] }}" target="_blank"><i class="fa {{ $row['class'] }}"></i></a>
                                @endforeach
                              </div>
                           </div>
                        </div>
                  ...
                  <div class="container">
                     <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                           <div class="info-text">
                              <div class="link-copy">
                                 <a href="{{url('collections?search=')}}">Tìm kiếm</a><span> | </span>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                           <div class="payment-footer">
                              <ul>
                                 <li><a href="#" title="Payment Method"><img src="{{ asset('template/giaodien4/images/payment-1.png') }}" alt="Payment"></a></li>
                                 <li><a href="#" title="Payment Method"><img src="{{ asset('template/giaodien4/images/payment-2.png') }}" alt="Payment"></a></li>
                                 <li><a href="#" title="Payment Method"><img src="{{ asset('template/giaodien4/images/payment-3.png') }}" alt="Payment"></a></li>
                                 <li><a href="#" title="Payment Method"><img src="{{ asset('template/giaodien4/images/payment-4.png') }}" alt="Payment"></a></li>
                              </ul>
                           </div>
                        </div>
                        -->
