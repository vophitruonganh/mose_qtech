               ...
               <div class="main-content">
                  <div class="col-md-12 img-span3-collections">
                     <div class="img-collec" style="padding-bottom:30px;">
                        <a href="{{ $seventhBanner['url'] }}">
                        <img src="{{ $seventhBanner['image'] }}">	
                        </a>	
                     </div>
                  </div>
                  <div class="col-md-12">
                              ...
                              <div class="product-block product-resize fixheight" style="height: 314px;">
                                 ...
                                 <div class="product-detail clearfix">
                                    ...
                                    <div class="actions clearfix">
                                     ...
                                     <form id="form_order_{{$i}}"action="{{ url('order/'.$product['product_slug'].'.html') }}" method="post" class="variants" id="product-actions-{{$product['product_id']}}" enctype="multipart/form-data">
                                        <input id="page_token" type="hidden" name="_token" value="{{ csrf_token() }}" />
                                         <input type="hidden" name="quantity" value="1" />
                                       <a class="btn-like mask-view" href="{{ url('collections/'.$product['product_slug']) }}" data-handle="/products/pin-sac-du-phong-10000-mah-x-mobile"><i class="fa fa-bar-chart"></i><span>Xem nhanh</span></a>
