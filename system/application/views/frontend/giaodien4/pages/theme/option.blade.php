...
<form action="{{ url('admin/template/option') }}" method="post">
  ...
  <div class="theme">
    ...
    <div id="welcome">
      ...
      <div><input type="text" name="welcome" value="{{ $optionValue['welcome'] }}" /></div>
    </div>
    <br/>
    <!-- End Welcome -->
    ...
    */
    ...
    <div id="slider_menu">
      ...
      @foreach( $slider_menu as $row )
        <div class="row" data-id="{{ $i }}">
          <div>Title: <input type="text" name="slider_menu[{{ $i }}][title]" value="{{ $row['title'] }}" /></div>
          <div>Url: <input type="text" name="slider_menu[{{ $i }}][url]" value="{{ $row['url'] }}" /></div>
          @if( $i > 0 ) <a class="remove" href="javascript:;">Remove</a> @endif
        </div>
      <br/>
      <?php $i++; ?>
    ...
    <div id="channel" data-plugin="upload">
      ...
      <?php $i = 0; ?>
      <div class="block">
      @foreach( $optionValue['channel'] as $row )
        <div class="row form-group" data-id="{{ $i }}">
          <div>Image: <input type="text" class="form-control" name="channel[{{ $i }}][image]" value="{{ $row['image'] }}" /></div>
          <span class="input-group-btn">
            <span class="fileUpload btn btn-primary">
              <span>Upload</span>
              <input type="file" name="file" class="upload" />
          ...
          <div>Title: <input type="text" name="channel[{{ $i }}][title]" value="{{ $row['title'] }}" /></div>
          <div>Url: <input type="text" name="channel[{{ $i }}][url]" value="{{ $row['url'] }}" /></div>
          @if( $i > 0 ) <a class="remove" href="javascript:;">Remove</a> @endif
        </div>
      <br/>
      <?php $i++; ?>
    ...
    <div id="seventhBanner" data-plugin="upload">
      <div class="form-group">
        ...
        <div>Url: <input type="text" name="seventhBanner[url]" value="{{ $optionValue['seventhBanner']['url'] }}" /></div>
        <div>Image: <input type="text" class="form-control" name="seventhBanner[image]" value="{{ $optionValue['seventhBanner']['image'] }}" /></div>
        <span class="input-group-btn">
          <span class="fileUpload btn btn-primary">
            <span>Upload</span>
            <input type="file" name="file" class="upload" />
    ...
    <div id="policy">
      ...
      @foreach( $optionValue['policy'] as $row )
        <div class="row" data-id="{{ $i }}">
          <div>Class: <input type="text" name="policy[{{ $i }}][class]" value="{{ $row['class'] }}" /></div>
    ...
    <div id="eighthBanner" data-plugin="upload">
      <div class="form-group">
        ...
        <div>Url: <input type="text" name="eighthBanner[url]" value="{{ $optionValue['eighthBanner']['url'] }}" /></div>
        <div>Image: <input type="text" class="form-control" name="eighthBanner[image]" value="{{ $optionValue['eighthBanner']['image'] }}" /></div>
        <span class="input-group-btn">
          <span class="fileUpload btn btn-primary">
            <span>Upload</span>
            <input type="file" name="file" class="upload" />
    ...
    <div id="ninthBanner" data-plugin="upload">
      <div class="form-group">
        ...
        <div>Url: <input type="text" name="ninthBanner[url]" value="{{ $optionValue['ninthBanner']['url'] }}" /></div>
        <div>Image: <input type="text" class="form-control" name="ninthBanner[image]" value="{{ $optionValue['ninthBanner']['image'] }}" /></div>
        <span class="input-group-btn">
          <span class="fileUpload btn btn-primary">
            <span>Upload</span>
            <input type="file" name="file" class="upload" />
    ...
    <div id="links">
      ...
      <div>Heading: <input type="text" name="links[heading]" value="{{ $links['heading'] }}" /></div>
      <br/>
      ...
      @foreach( $links as $row )
        <div class="row" data-id="{{ $i }}">
          <div>Title: <input type="text" name="links[{{ $i }}][title]" value="{{ $row['title'] }}" /></div>
          <div>Url: <input type="text" name="links[{{ $i }}][url]" value="{{ $row['url'] }}" /></div>
          @if( $i > 0 ) <a class="remove" href="javascript:;">Remove</a> @endif
        </div>
      <br/>
      <?php $i++; ?>
    ...
    <div id="support">
      ...
      <div>Heading: <input type="text" name="support[heading]" value="{{ $support['heading'] }}" /></div>
      <br/>
    ...
    <div id="service_menu">
      ...
      <div>Heading: <input type="text" name="service_menu[heading]" value="{{ $service_menu['heading'] }}" /></div>
      <br/>
      <?php unset($service_menu['heading']); ?>
      <?php $i = 0; ?>
      <div class="block">
      @foreach( $service_menu as $row )
        <div class="row" data-id="{{ $i }}">
          <div>Title: <input type="text" name="service_menu[{{ $i }}][title]" value="{{ $row['title'] }}" /></div>
          <div>Url: <input type="text" name="service_menu[{{ $i }}][url]" value="{{ $row['url'] }}" /></div>
          @if( $i > 0 ) <a class="remove" href="javascript:;">Remove</a> @endif
        </div>
      <br/>
      <?php $i++; ?>
