         ...
         @if( count($errors) > 0 )
            ...
            <form accept-charset="UTF-8" action="{{url('customer/register')}}" id="create_customer" method="post">
               ...
               <div id="last_name" class="clearfix large_form">
                  ...
                  <input  type="text" value="{{old('name')}}" name="name" placeholder="Họ và tên" id="last_name" class="text" size="30">
               </div>
               ...
               <div id="password" class="clearfix large_form">
                  ...
                  <input  type="password" value="{{old('password')}}" placeholder="Mật khẩu" name="password" id="password" class="password text" size="30">
               </div>
               <div id="password" class="clearfix large_form">
                  <label for="password" class="label icon-field"><i class="icon-login icon-shield "></i></label>
                  <input  type="password" value="{{old('password_confirmation')}}" placeholder="Xác nhận mật khẩu" name="password_confirmation" id="password" class="password text" size="30">
               </div>
               ...
               <div class="req_pass">
                  <a class="come-back" href="{{ url('customer/login') }}">Quay về trang đăng nhập</a>
               </div>
            </form>
         </div>
      </div>
