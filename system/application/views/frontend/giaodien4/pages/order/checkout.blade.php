...
@section('content')
 ...
 <form method="post" action="{{ url('cart/checkout.html') }}" data-toggle="validator" class="formCheckout">
                        ...
                        <div class="row">
                            <div class="col-md-4 col-sm-6">
                                ...
                                <div class="form-group">
                                    <a href="{{ url('customer_register.html') }}">Đăng ký tài khoản mua hàng</a>
                                    |
                                    <a href="{{ url('login.html') }}">Đăng nhập </a>
                                </div>
                                <hr class="divider">
                                 @if( count($errors) > 0 )
                                ...
                                <!--thông tin mua hang-->   
                                <div class="form-group">
                                    <input type="email" class="form-control" name="email" id="BillingAddress_Email" placeholder="Email" value="{{old('email')}}">
                                </div>
                                <div class="form-group">
                                    <input class="form-control" name="nickname" id="BillingAddress_LastName" placeholder="Họ và tên" value="{{old('nickname')}}">
                                </div>
                                <div class="form-group">
                                    <input class="form-control" name="phone" id="BillingAddress_Phone" placeholder="Số điện thoại" value="{{old('phone')}}" />
                                </div>
                                <div class="form-group">
                                    <input name="address" id="BillingAddress_Address1" class="form-control" placeholder="Địa chỉ" value="{{old('address')}}" />
                                </div>
                                <div class="form-group">
