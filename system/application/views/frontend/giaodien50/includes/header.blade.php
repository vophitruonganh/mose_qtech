                        ...
                        <div class="col-sm-12 col-xs-12 col-lg-8 col-md-8 col-md-8">
                            <div class="header-left">
                                <div class="header-email">
                                    <i class="fa fa-clock-o"></i>{{ $openDoor }}
                                </div>
                                <div class="header-email">
                                    <i class="fa fa-envelope"></i>{{ $storeSetting['email'] }}
                                </div>
                                <div class="header-email">
                                    <strong><i class="fa fa-phone"></i> hotline:</strong> {{ $storeSetting['telephone'] }}
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="header-right">
                                <div class="menu-top-menu">
                                    <ul>
                                        ...
                                        {
                                        ?>
                                        <li><a href="{{ url('customer') }}">Chỉnh sửa</a></li>
                                        <li><a href="{{ url('customer/logout') }}">Thoát</a></li>
                                        <?php
                                        }
                                        else
                                        {
                                        ?>
                                        <li><a href="{{ url('customer/login') }}">Đăng nhập</a></li>
                                        <li><a href="{{ url('customer/register') }}">Đăng ký</a></li>
                                        <?php
                                        }
                                        ?>
                                    </ul>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-xs-12 col-lg-3 col-md-3">
                        <div class="logo">
                            <a class="logo" href="{{ url('/') }}"><img src="{{ $logo_main }}" /></a>
                        </div>
                    </div>
                        ...
                        <div class="search-cart-list">
                            <div class="header-search">
                                <form action="{{ url('collections') }}" method="get" >
                                    <div>
                                        <input type="text" placeholder="Tìm kiếm..." name="search" maxlength="70" value="{{$search}}">
                                    ...
                                    <li>
                                        <a class="cart-toggler" href="{{url('cart')}}">
                                            ...
                                            <span class="cart-no">
                                                ...
                                                <spam id="cart-total">{{$total_quantity }}</spam>
                                                sản phẩm
                                            </span>
                                        </a>
                            ...
                            <div class="main-menu">
                                <nav>
                                    <ul>
                                        ...
                                        <li class="{{ (Request::is('pages/gioi-thieu') ? 'active' : '') }}"><a href="{{ url('pages/gioi-thieu') }}">Giới thiệu</a></li>
                                        <li class="{{ ((Request::is('collections') || Request::is('collections/san-pham-noi-bat') || Request::is('collections/discount')) ? 'active' : '') }}">
                                            <a href="{{ url('collections') }}">Sản phẩm <i class="fa fa-angle-down"></i></a>
                                            <ul class="sup-menu">
                                                <li>
                                                    <a href="{{ url('collections') }}">Tất cả sản phẩm</a>
                                                </li>
                                                <!--
                                                <li>
                                                    <a href="{{ url('product_new.html') }}">Sản phẩm mới</a>
                                                </li>
                                                -->
                                                <li>
                                        ...
                                        <!--
                                        <li class="{{ (Request::is('product_new.html') ? 'active' : '') }}"><a href="{{ url('product_new.html') }}">Sản phẩm mới</a></li>
                                        -->
                                        <li><a href="{{ url('tin-chinh') }}">Tin tức</a></li>
                                        <li class="{{ (Request::is('pages/contact*') ? 'active' : '') }}"><a href="{{ url('pages/contact') }}">Liên hệ</a></li>
                                    </ul>
                                </nav>
                            </div>
                        </div>
                            ...
                            <div class="mobile-menu">
                                <nav id="dropdown">
                                    <ul>
                                        ...
                                        <!--
                                        <li><a href="{{ url('product_new.html') }}">Sản phẩm mới</a></li>
                                        -->
                                        <li><a href="{{ url('tin_chinh') }}">Tin tức</a></li>
