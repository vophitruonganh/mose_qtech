...
?>
<form method="post" action="{{ url('cart/checkout') }}" data-toggle="validator" class="formCheckoutOrder">
                ...
                <div class="wrap clearfix">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-6">
                            ...
                            <div class="form-group">
                                <input class="form-control" name="fullname" id="fullname" placeholder="fullname" value="{{old('fullname',$fullname)}}">
                            </div>
                            <div class="form-group">
                                <input class="form-control" name="phone" id="phone" placeholder="Số điện thoại" value="{{old('phone',$phone)}}">
                            </div>
                            <div class="form-group">
                                <input name="address" id="address" class="form-control" placeholder="Địa chỉ" value="{{old('address',$address)}}">
                            </div>
                            <div class="form-group">
                                       ...
                                       @if($cart_order)
                                           ...
                                           @foreach( $cart_order as $cart)
                                            ...
                                            <li class="product product-has-image clearfix">
                                                <img src="{{set_image_size(get_image_url($cart['variant_image']),'thumb')}}" alt="{{ $cart['product_title'] }}" class="pull-left product-image">
                                                <div class="product-info pull-left">
                                                    <span class="product-info-name">
                                                    <strong>{{ $cart['product_title'] }}</strong> x {{ $cart['quantity'] }}
