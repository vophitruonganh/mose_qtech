            ...
            <div class="container">
               <div class="row">
                  ...
                  <div class="col-xs-6">
                     ...
                     <div class="welcome-msg hidden-xs">Chào mừng bạn @if( strlen($siteName) > 0 ) tới <a>{{ $siteName }}</a> @endif | Hotline : <a>{{ $storeSetting['telephone'] }}</a></div>
                     <div class="account-msg visible-xs">
                        <a class="msg">Tài khoản <i class="fa fa-angle-down"></i></a>
                        <ul class="account-msg-hidden">
                           <li><a title="Register" href="{{url('customer/register')}}"><span><i class="fa fa-key"></i>Đăng ký</span></a></li>
                           <li><a title="Login" href="{{url('customer/login')}}"><span><i class="fa fa-lock"></i>Đăng nhập</span></a></li>
                        </ul>
                     </div>
                  </div>
                  <div class="col-xs-6">
                     ...
                     <div class="toplinks">
                        <div class="links hidden-xs">
                         @if( Session::has('loginFrontend') )
                           <div class="login"><a title="Login" href="{{url('customer')}}"><span  class="hidden-xs">Chỉnh sửa</span></a></div>
                           <div class="login"><a title="Login" href="{{url('customer/logout')}}"><span  class="hidden-xs">Đăng xuất</span></a></div>
                         @else
                           <div class="register"><a title="Register" href="{{url('customer/register')}}"><span  class="hidden-xs">Đăng ký</span></a></div>
                           <div class="login"><a title="Login" href="{{url('customer/login')}}"><span  class="hidden-xs">Đăng nhập</span></a></div>
                         @endif
                        
                        </div>
                        <div class="links visible-xs">
                           <div><a title="search" href="/search"><span class="fa fa-search"></span></a></div>
                           <div class="bag_shop" onclick="window.location.href='/cart'"><a title="cart" href="/cart"><span class="cart-total">{{$total_quantity}}</span></a></div>
                        </div>
                     </div>
            ...
            <div class="row">
               ...
               <div class="col-lg-5 col-sm-5 col-md-5">
                  ...
                  <?php $search = isset($_GET['search']) ? $_GET['search']: '' ?>
                     <form action="{{url('collections')}}" method="get" id="search_mini_form">
                        <input type="text" placeholder="Nhập thông tin tìm kiếm" value="{{$search}}" maxlength="70" class="" name="search" id="search">
               ...
               <div class="col-lg-3 col-sm-3 col-md-3">
                     ...
                     <div class="mini-cart" id="open_shopping_cart">
                        <div data-toggle="dropdown" data-hover="dropdown" class="basket dropdown-toggle">
                           <a href="{{url('cart')}}">
                              <i class="icon_bag"><span class="count_item_pr cart-total">{{$total_quantity}}</span></i>
                              <div class="cart-box"><span class="title">Giỏ hàng</span><span class="count_pr">(<span class="cart-total">{{$total_quantity}}</span>)&nbsp;sản phẩm</span></div>
                           </a>
                        </div>
                        <div>
                           {!! $xhtml !!}
         ...
         <div class="container">
            <div class="nav-inner">
               <div class="logo-small hidden-sm hidden-md"> 
                  ...
                  <img alt="Bike-themes" src="{{asset('template/giaodien11/asset/images/logo.png')}}" />
                  </a>
               </div>
               <!-- mobile-menu -->
                  ...
                  <ul class="navmenu">
                     <li>
                        ...
                        <ul class="submenu">
                           <li>
                              <ul class="topnav">
                                 <li class="level0 nacvv-8 level-top parent  active "> <a class="level-top" href="{{url('/')}}"> <span>Trang chủ</span> </a></li>
                                 <li class="level0 nacvv-8 level-top parent "> <a class="level-top" href="{{url('pages/gioi-thieu')}}"> <span>Giới thiệu</span> </a></li>
                                 <li class="level0 nav-8 level-top parent ">
                                    <a class="level0 nav-8 level-top parent" href="{{url('collections')}}"> <span>Sản phẩm</span> </a>
                                    <!-- <ul class="level0">
                                       <li class="level1 nav-2-1 first parent "> <a href="{{url('collections')}}"> <span>Sản phẩm mới</span> </a></li>
                                       <li class="level1 nav-2-1 first parent "> <a href="{{url('collections/san-pham-noi-bat')}}"> <span>Sản phẩm nổi bật</span> </a></li>
                                       <li class="level1 nav-2-1 first parent "> <a href="{{url('collections/discount')}}"> <span>Sản phẩm khuyến mãi</span> </a></li>
                                 ...
                                 <li class="level0 nacvv-8 level-top parent "> <a class="level-top" href="{{url('tin-chinh')}}"> <span>Tin tức</span> </a></li>
                               <li class="level0 nacvv-8 level-top parent "> <a class="level-top" href="{{url('pages/contact')}}"> <span>Liên hệ</span> </a></li>
               ...
               <ul id="nav" class="hidden-xs">
                  <li class="level0 parent drop-menu  active "><a href="{{url('/')}}"><span>Trang chủ</span></a></li>
                  <li class="level0 parent drop-menu "><a href="{{url('pages/gioi-thieu')}}"><span>Giới thiệu</span></a></li>
                  <li class="level0 parent drop-menu ">
                     <a href="{{url('collections')}}"><span>Sản phẩm <i style="float: right;margin: 1px 5px;" ></i></span></a>
                     <ul class="level1">
                        <i class="fa fa-sort-asc icon_arr"></i>
                        <li class="level1 first parent "><a href="{{url('collections')}}"><span>Sản phẩm mới</span></a></li>
                        <li class="level1 first parent "><a href="{{url('collections/san-pham-noi-bat')}}"><span>Sản phẩm nổi bật</span></a></li>
                        <li class="level1 first parent "><a href="{{url('collections/discount')}}"><span>Sản phẩm khuyến mãi</span></a></li>
                  ...
                  <li class="level0 parent drop-menu "><a href="{{url('tin-chinh')}}"><span>Tin tức</span></a></li>
                  <li class="level0 parent drop-menu "><a href="{{url('pages/contact')}}"><span>Liên hệ</span></a></li>
               </ul>
               -->
               {!! navigation_menu('top_menu','','nav') !!}
            </div>
         </div>
      </nav>
      <!-- end nav -->