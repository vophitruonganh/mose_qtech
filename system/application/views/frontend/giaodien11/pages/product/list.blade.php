...
<div class="main-container col2-left-layout">
   ...
   <div class="category-products">
      <div class="toolbar">
         <div class="sorter">
            <div class="view-mode"> 
               <a href="{{url('collections?view=grid')}}" title="Grid" class="button-active"><i class="fa fa-th"></i></a> 
      ...
      <ol id="products-list" class="products-list">
        @if(count($products)>0)
            @foreach($products as $product)
             <li class="item even">
                <div class="product-image"> <a href="{{url('collections/'.$product['product_slug'])}}" title="{{$product['product_title']}}"> <img class="small-image" src="{{get_image_url($product['product_image_id'])}}" width="230"> </a> </div>
                <div class="product-shop">
                   <h3 class="product-name"><a title="{{$product['product_title']}}" href="{{url('collections/'.$product['product_slug'])}}">{{$product['product_title']}}</a></h3>
                   <div class="desc std">
