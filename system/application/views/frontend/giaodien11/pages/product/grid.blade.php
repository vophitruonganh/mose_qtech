               ...
               <div class="toolbar">
                  <div class="sorter">
                     <div class="view-mode"> 
                        ...
                        <a href="{{url('collections?view=list')}}" title="List" class=""><i class="fa fa-list"></i></a> 
                     </div>
                  </div>
                        ...
                        <div class="info">
                           <div class="info-inner">
                              <div class="item-title">
                                 <h3><a title="Xe đạp không phanh Fornix" href="{{url('collections/'.$product['product_slug'])}}">{{$product['product_title']}}</a></h3>
                              </div>
                              <!--item-title-->
