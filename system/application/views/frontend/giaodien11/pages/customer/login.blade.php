         ...
         <fieldset class="col2-set">
            ...
            <div class="col-2 registered-users">
               ...
               <div class="content">
                  ...
                  <form accept-charset="UTF-8" action="{{ url('customer/login') }}" id="customer_login" method="post" style="display: block;">
            ...
            <div class="col-1 new-users">
               ...
               <div class="content">
                  ...
                  <div class="buttons-set">
                     <button onclick="window.location='{{url("customer/register")}}';" class="button create-account" type="button"><span>Tạo tài khoản</span></button>
                  </div>
               </div>
            </div>
         </fieldset>
