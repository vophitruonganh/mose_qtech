                       ...
                       <div class="col-lg-12 col-md-12 col-sm- col-xs-12 collection_header">
                          ...
                          <div class="col-lg-6 col-md-8 col-sm-8 col-xs-12 toolbar pd_0 ">
                             <div id="sort-by">
                                ...
                                <form class="form-inline form-viewpro" id="filter_product" method="get">
                             ...
                             <div class="sorter ">
                               <div class="view-mode">
                                  <span title="Lưới" class=" collection_btn active view_grid"> <a href="{{(!isset($_GET['view']) || $_GET['view']=='grid')? 'javascript:void(0);' : url('collections/'.$slug.'?view=grid')}}"  ><i class="fa fa-th" aria-hidden="true"></i></a></span>
                                 
                                  <span title="Danh sách" class="collection_btn view_list"><a href="{{(isset($_GET['view']) && $_GET['view']=='list')? 'javascript:void(0);' : url('collections/'.$slug.'?view=list')}}" ><i class="fa fa-th-list" aria-hidden="true"></i></a></span>
                               </div>
                            </div>
                          </div>
                       </div>
                                   ...
                                   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pd_0 mg_bt">
                                      <div class="prd-loop-list prd-loop-list-collection">
                                         <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 loop-img">
                                            <a href="{{url($product['product_slug'])}}">
                                            <img src="{{ get_image_url($product['product_image_id']) }}" alt="{{$product['product_title']}}">
                                            </a>
                                         </div>
                                         <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12 loop-content">
                                            <div>
                                               <h3 class="item-name fw600"><a href="{{url($product['product_slug'])}}">{{$product['product_title']}}</a></h3>
                                               <p class="item-price cl_price fs18 mg_bt_10 fw600"><span>{{number_format($product['price_new'],0,'.','.')}}₫</span></p>
                                               ...
                                               <div class="mg_20_0">
                                                  ...
                                                  <button class="btn btn-view btn-cus" onclick="window.location.href='{{url($product['product_slug'])}}'">Xem chi tiết</button>
                                               </div>
                                            </div>
                                         </div>
                                      </div>
