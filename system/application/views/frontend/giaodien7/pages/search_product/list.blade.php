                    ...
                    <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 right-panel collections">
                       <div class="col-lg-12 col-md-12 col-sm- col-xs-12 collection_header">
                          ...
                          <div class="col-lg-6 col-md-8 col-sm-8 col-xs-12 toolbar pd_0 ">
                             ...
                             <div class="sorter ">
                                <div class="view-mode"> 
                                   <a href="{{(!isset($_GET['view']) || $_GET['view']=='grid')? 'javascript:void(0);' : url('collections?view=grid&search='.$search)}}" title="Lưới" class="collection_btn"><i class="fa fa-th" aria-hidden="true"></i></a>
                                   <span title="Danh sách" class="active collection_btn"><a href="{{(isset($_GET['view']) && $_GET['view']=='list')? 'javascript:void(0);' : url('collections?view=list&search='.$search)}}" ><i class="fa fa-th-list" aria-hidden="true"></i></a></span>
                                </div>
                             </div>
                          </div>
                       </div>
