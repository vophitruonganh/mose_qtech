               ...
               <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 right-panel collections ">
                  <div class="col-lg-12 col-md-12 col-sm- col-xs-12 collection_header">
                     ...
                     <div class="col-lg-6 col-md-8 col-sm-8 col-xs-12 toolbar pd_0 ">
                        ...
                        <div class="sorter ">
                           <div class="view-mode">
                              <span title="Lưới" class=" collection_btn active view_grid"> <a href="{{(!isset($_GET['view']) || $_GET['view']=='grid')? 'javascript:void(0);' : url('collections?view=grid&search='.$search)}}"  ><i class="fa fa-th" aria-hidden="true"></i></a></span>
                              <!--<a href="?view=list" title="Danh sách" class="collection_btn view_list"><i class="fa fa-th-list" aria-hidden="true"></i></a>-->
                              <span title="Danh sách" class="collection_btn view_list"><a href="{{(isset($_GET['view']) && $_GET['view']=='list')? 'javascript:void(0);' : url('collections?view=list&search='.$search)}}" ><i class="fa fa-th-list" aria-hidden="true"></i></a></span>
                           </div>
                        </div>
                     </div>
                  </div>
