         ...
         <div class="collection__sort section-header">
            <div class="section-header__right">
               ...
               <div class="collection-view left">
                  <button type="button" onclick="window.location='{{url("collections/$slug?view=grid")}}'" title="Lưới xem" class="change-view" data-view="grid">
                  <span class="icon-fallback-text">
                  <span class="icon icon-grid-view" aria-hidden="true"></span>
                  <span class="fallback-text">Lưới xem</span>
                  </span>
                  </button>
                  <button type="button" onclick="window.location='{{url("collections/$slug?view=list")}}'" title="Danh sách xem" class="change-view change-view--active" data-view="list">
                  <span class="icon-fallback-text">
