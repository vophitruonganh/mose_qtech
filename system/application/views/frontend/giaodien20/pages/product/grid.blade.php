         ...
         <div class="collection__sort section-header">
            <div class="section-header__right">
               ...
               <div class="collection-view left">
                  <button type="button" title="Lưới xem" onclick="window.location='{{url("collections?view=grid")}}'" class="change-view change-view--active" data-view="grid">
                  <span class="icon-fallback-text">
                  <span class="icon icon-grid-view" aria-hidden="true"></span>
                  <span class="fallback-text">Lưới xem</span>
                  </span>
                  </button>
                  <button type="button" onclick="window.location='{{url("collections?view=list")}}'" title="Danh sách xem" class="change-view" data-view="list">
                  <span class="icon-fallback-text">
