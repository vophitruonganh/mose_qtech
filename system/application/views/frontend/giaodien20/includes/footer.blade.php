       ...
       <div class="site-footer__main grid">
          ...
          <div class="grid__item large--one-quarter medium--one-quarter">
             ...
             <div class="social">
                ...
                <a href="{{ $row['url'] }}"><i class="icon {{ $row['class'] }}"></i></a>
                 @endforeach
             </div>
             <h4>Thanh toán</h4>
             <div class="inner">
                <a class="i-payment" href="#" title=""><img src="{{asset('template/giaodien20/asset/images/payment1.jpg')}}" alt=''  /></a>
                <a class="i-payment" href="#" title=""><img src="{{asset('template/giaodien20/asset/images/payment2.jpg')}}" alt=''  /></a>
                <a class="i-payment" href="#" title=""><img src="{{asset('template/giaodien20/asset/images/payment3.jpg')}}" alt=''  /></a>
                <a class="i-payment" href="#" title=""><img src="{{asset('template/giaodien20/asset/images/payment4.jpg')}}" alt=''  /></a>
                <a class="i-payment" href="#" title=""><img src="{{asset('template/giaodien20/asset/images/payment5.jpg')}}" alt=''  /></a>
             </div>
          </div>
       </div>
       <!-- end main -->
...
<script src="{{ asset('template/giaodien20/asset/js/fastclick.min.js?v=96') }}" type='text/javascript'></script>
     <script src="{{ asset('template/giaodien20/asset/js/timber.js?v=96') }}" type='text/javascript'></script>
      <script src="{{ asset('template/giaodien20/asset/js/owl.carousel.min.js?v=96') }}" type='text/javascript'></script>
      <script src="{{ asset('template/giaodien20/asset/js/wow.min.js?v=96') }}" type='text/javascript'></script>
