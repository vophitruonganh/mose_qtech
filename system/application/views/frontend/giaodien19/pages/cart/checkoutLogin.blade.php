                     ...
                     <div class="wrap clearfix">
                        <div class="row">
                           <div class="col-md-5 col-sm-6">
                              ...
                              <div class="form-group">
                                 <input class="form-control" name="phone" id="phone" placeholder="Số điện thoại" value="{{ $user->user_telephone }}" disabled>
                              </div>
                              <div class="form-group">
                                 <input name="address" id="address" class="form-control" placeholder="Địa chỉ" value="{{ $address }}" disabled>
                              </div>
