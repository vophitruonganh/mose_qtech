                     ...
                     <div class="wrap clearfix">
                        <div class="row">
                           ...
                           <div class="col-md-4 col-sm-6">
                              ...
                              <!--thông tin mua hang-->
                              <div class="form-group">
                                 <input type="email" class="form-control" name="email" id="BillingAddress_Email" placeholder="Email">
                              </div>
                              <div class="form-group">
                                 <input class="form-control" name="name" id="BillingAddress_LastName" placeholder="Họ và tên">
                              </div>
                              <div class="form-group">
                                 <input class="form-control" name="phone" id="BillingAddress_Phone" placeholder="Số điện thoại">
                              </div>
                              <div class="form-group">
                                 <input name="address" id="BillingAddress_Address1" class="form-control" placeholder="Địa chỉ">
                              </div>
                              <div class="form-group">
