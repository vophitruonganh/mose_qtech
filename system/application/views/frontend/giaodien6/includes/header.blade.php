                         ...
                         <div class="row">
                                  ...
                                  <div class="box-search">
                                     <div class="box-input">                                        
                                        <div class="input-group-search" style="">
                                           <input type="text" name="search" value="{{$query}}" placeholder="Nhập từ khóa tìm kiếm" />
                                        </div>
                            ...
                            <div class="col-lg-2 col-md-2 hidden-sm hidden-xs">
                               <div class="box-check-header">
                                  ...
                                  <span class="fone-header">{{ $phone }}</span>
                      ...
                      <div class="row">
                         <div class="navbar-header">
                            ...
                            <div class="pull-right mobile-menu-icon-wrapper">
                               <div class="logo logo-mobile">
                                  <a href="{{ url('/') }}">
                                  <img src="{{ asset('template/giaodien6/asset/images/logo.png') }}" alt="Saga Hamburg" />
                                  </a>
                               </div>
                                     ...
                                     <div class="btn-group">
                                        ...
                                        <div class="dropdown-menu" role="menu">
                                           <div class="search-bar">
                                              <div class="">
                                                 <form class="col-md-12" action="{{ url('collections?search='.$query) }}" method="get">
                         ...
                         <div id="navbar" class="navbar-collapse collapse">
                            <div class="clearfix" id="menu">
                              {!! navigation_menu('top_menu','nav navbar-nav clearfix') !!}
                              <?php
                              /*
                               ...
                               */
                               ...
                               <ul class="pull-right hidden-xs account_register">
                                  <li><a class="register_account" href="{{ url('customer/register') }}" title="Đăng ký">ĐĂNG KÝ</a></li>
                                  <li><a href="javascript:void(0);">hay</a></li>
                                  <li><a class="login_account" href="{{ url('customer/login') }}" title="Đăng nhập">Đăng nhập</a></li>
                               </ul>
                               @else
                               <ul class="pull-right hidden-xs account_register">
                                  <li><a href="{{ url('customer') }}" title="Thoát">Chỉnh sửa</a></li>
                                  <li><a href="{{ url('customer/logout') }}" title="Thoát">Thoát</a></li>
                               </ul>
                               @endif
                            </div>
                         </div>
