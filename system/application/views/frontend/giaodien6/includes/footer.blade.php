      ...
      <div class="container">
         <div class="row">
            ...
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 pd5 wow animated fadeInLeft">
               <div class="hotline">
                  <p>{{ $hotline['text1'] }}</p>
                  <span class="free-call">{{ $hotline['text2'] }}</span>
               </div>
               <div class="number-phone">
                  <h3 class="call-number">{{ $hotline['text3'] }}</h3>
               </div>
            </div>
         </div>
      </div>
            ...
            <div class="row">
               <div class="col-md-3 col-sm-6 col-xs-12 pd5 wow animated fadeInUp" data-wow-delay="100ms">
                  <div class="footer-block" id="block_links_footer_1">
                     <h4 class="title_block">{{ $information['heading'] }}</h4>
               ...
               <div class="col-md-3 col-sm-6 col-xs-12 pd5 wow animated fadeInUp" data-wow-delay="100ms">
                  <div class="footer-block" id="block_links_footer_2">
                     <h4 class="title_block">{{ $customer_link['heading'] }}</h4>
                     <div class="block_content">
                        <ul class="toggle-footer list-group bullet">
               ...
               <div class="col-md-3 col-sm-6 col-xs-12 pd5 wow animated fadeInUp" data-wow-delay="100ms">
                  <div class="footer-block" id="block_links_footer_3">
                     <h4 class="title_block">{{ $support['heading'] }}</h4>
                     <div class="block_content">
                        <ul class="toggle-footer list-group bullet">
            ...
            <div class="footer-bottom-wrap clearfix">
                  ...
                  <div class="block_aboutshop block">
                     <div class="block_content">
                        <div class="box logo-ft">
                           <a href="{{ url('/') }}">
                              <img src="{{ $logo_footer }}" class="img-responsive"/>
                           </a>
                        </div>
                     </div>
                  </div>
               ...
               <div class="col-lg-5 col-md-5 col-sm-6 col-xs-12 pd5 border-left wow animated fadeInUp" data-wow-delay="150ms">
                  <div class="block footer_contact">
                     <div class="block_content">
                        <ul class="list">
                           <li><i class="fa fa-map-marker">&nbsp;</i> - Địa chỉ: {{ $storeSetting['address'] }}</li>
                           <li><i class="fa fa-phone">&nbsp;</i>- Điện thoại: {{ $storeSetting['telephone'] }}</li>
                           <li><i class="fa fa-envelope">&nbsp;</i>- Địa chỉ email: {{ $storeSetting['email'] }}</li>
                        </ul>
                     </div>
                  </div>
               </div>
               <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 pd5 text-right wow animated fadeInRight" data-wow-delay="150ms">
                  ...
                  <div class="social pull-right">
                     <ul class="list-unstyled clearfix">
                        ...
                        <li class="facebook">
                           <a target="_blank"  href="{{ $row['url'] }}"  class="fa {{ $row['class'] }}"></a>
                        </li>
                        @endforeach
                     </ul>
                  </div>
...
<script src="{{ asset('template/giaodien6/asset/js/cutums.js') }}" type='text/javascript'></script>
