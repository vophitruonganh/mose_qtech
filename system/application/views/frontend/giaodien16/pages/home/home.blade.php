	...
	<div class="container">
		...
		<aside class="col-lg-3 col-md-3 hidden-sm hidden-xs">
			...
			<div class="quangcao block">
				@foreach($image_sidebar as $row)
					<img src="{{$row['image']}}" alt="Quảng cáo"/>
				@endforeach
			</div>
			<!-- Widget 33333333 -->
		...
		<article class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
			<!-- Widget 44444444 -->
				{!!showWidget('widget44444444')!!}
			<!-- End Widget 44444444 -->

			<section class="article_ads hidden-xs">
				@foreach($first_banner as $row)
					<img src="{{$row['image']}}" width="840" alt="Big Shoe">
				@endforeach
			</section>
			<!-- Widget 55555555 -->
				{!!showWidget('widget55555555')!!}
			<!-- End Widget 55555555 -->
			

			<section class="article_ads hidden-xs">
				@foreach($second_banner as $row)
					<img src="{{$row['image']}}" width="840" alt="Big Shoe">
				@endforeach
				
			</section>
			<!-- Widget 66666666 -->
				{!!showWidget('widget66666666')!!}
			<!-- End Widget 66666666 -->
