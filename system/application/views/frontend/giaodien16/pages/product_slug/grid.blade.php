      ...
      <article class="col-lg-9 col-md-9 col-sm-9 col-xs-12 article">
         <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 collection_header">
            <div class="col-lg-6 col-md-6 col-sm-5 col-xs-12">
               <h2 class="txt_u fw_600 pull-left">{{$title_name}}</h2>
            </div>
            <div class="toolbar">
               <div class="sorter">
                  <div class="view-mode"> 
                     <span title="Lưới" class="collection_btn active"><i class="fa fa-th" aria-hidden="true"></i></span>
                     <a href="{{url('collections/'.$slug.'?view=list')}}" title="Danh sách" class="collection_btn"><i class="fa fa-th-list" aria-hidden="true"></i></a> 
                  </div>
               </div>
            <!--    <div id="sort-by">
