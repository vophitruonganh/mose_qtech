 <footer id="footer">
            ...
            <div class="container">
               <div class="row">
                  <div class="col-lg-3 aboutus col-sm-6">
                     <h2>{{ isset($about['title']) ? $about['title'] : '' }} </h2>
                     <div class="text-about-us"> {{isset($about['text']) ? $about['text'] : '' }}</div>
                  </div>
                  <div class="col-lg-3 contact col-sm-6">
                     ...
                     <ul>
                        <?php 
                          ...
                          ?>
                        <li class="phone"> {{ $phone1 }} </li>
                        <li class="mobile">{{ $phone2 }}</li>
                        <li class="email"> <a href="mailto:{{ $storeSetting['email'] }}">{{ $storeSetting['email'] }}</a></li>
                        <li class="email"> <a href="{{ url('/') }}" target="_blank">{{ url('/') }}</a></li>
                     </ul>
                  </div>
                     ...
                     <div id="sns_facebook_16999696191449829151" class="sns-facebook">
                        <div id="fb-root">
                           <div class="facebook-fanbox" style="overflow-x : hidden;">
                              <div class="fb-like-box" data-href="{{ $facebook['url'] }}" data-colorscheme="light" data-show-faces="true" data-header="false" data-stream="false" data-width="500" data-show-border="false">
                              </div>
                           </div>
                        </div>
                     </div>
         ...
         <section class="copyrightbottom">
            <div class="container">
               <div class="row">
                  <div class="col-lg-12">{!! $copyright['text'] !!}</div>
               </div>
            </div>
         </section>
      </footer>
