                            ...
                            <div class="wrap clearfix">
                                <div class="row">
                                    <div class="col-md-4 col-sm-6">
                                        ...
                                        <!--thông tin mua hang-->
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="email" id="email" placeholder="Email" value="{{ old('email',$email) }}">
                                        </div>
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="fullname" id="BillingAddress_LastName" placeholder="Họ và tên" value="{{ old('fullname',$fullname) }}">
                                        </div>
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="phone" id="phone" placeholder="Số điện thoại" value="{{ old('phone',$phone) }}">
                                        </div>
                                        <div class="form-group">
                                            <input type="text" name="address" id="BillingAddress_Address1" class="form-control" placeholder="Địa chỉ" value="{{ old('address',$address) }}">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="order-summary order-summary--custom-background-color ">
                                            ...
                                            <div class="summary-section clearfix">
                                                ...
                                                <div class="total-line total-line-shipping clearfix" bind-show="requiresShipping">
                                                    <div class="row">
                                                        <div class="col-lg-6 total-line-name pull-left discount-title">{{ $cart_meta['title'] }}</div>
                                                        <div class="col-lg-6 total-line-shipping pull-right discount-price"><span class="pull-right">@if($cart_meta['title'])- {{ number_format($cart_meta['discount_price'], 0, ',', '.') }}₫ @endif</span></div>
                                                    </div>
                                                    <!--
                                                ...
                                                <div class="total-line total-line-total">
                                                    ...
                                                    <span class="total-line-price pull-right total-price">{{ number_format($cart_meta['total'], 0, ',', '.') }}₫</span>
                                                </div>
                                            </div>
                                        </div>
