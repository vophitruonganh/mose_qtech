...
<div class="container">
	<ul class="breadcrumb">
      <li><a href="http://store.moseplus.com" target="_self">Trang chủ</a></li>
      <li class="active"><span>Sổ địa chỉ</span></li>
  </ul>
</div>
                           ...
                           <div class="row">
                              <div style="border:solid 1px #dedede; padding:10px;float: left;width: 99%;">
                                 ...
                                 <p style="margin:10px 0px;">
                                    <button type="button" class="btn btn-orange theme_sua2" name="Sửa" value="">Sửa</button>
                                 </p>
                                          ...
                                          <div class="col-md-12">
                                             <ul class="form-list">
                                                ...
                                                <li>
                                                   ...
                                                   <button style=" margin-left: 20px;" type="submit" class="btn btn-orange" name="update" value="update_all">Cập nhật</button>
                                                    hoặc     
                                                   <a href="#" class=" btn theme_sua2">Hủy</a>
                                                </li>
                                             </ul>
                                          </div>
                                       </div>
