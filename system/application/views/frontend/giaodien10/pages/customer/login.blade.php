                    ...
                    <div id="login" class="userbox form-horizontal">
                        ...
                        <form accept-charset="UTF-8" action="{{ url('customer/login') }}" id="customer_login" method="post">
                            ...
                            <div class="clearfix large_form control-group">
                                ...
                                <div class="controls">
                                    <input  type="email" value="" name="email" id="customer_email" placeholder="Email" class="text">
                                </div>
                            </div>
                            <div class="clearfix large_form control-group">
                                <label for="customer_password" class="control-label"><span class="red">*</span> Mật khẩu</label>
                                <div class="controls">
                                    <input  type="password" value="" name="password" id="customer_password" placeholder="Mật khẩu" class="text" size="16">      
                                </div>
                            </div>
                            ...
                            <div class="clearfix large_form control-group">
                                ...
                                <div class="req_pass controls">
                                    ...
                                    -->
                                    <a href="{{ url('customer/register') }}" title="Đăng ký" class="">Đăng ký</a>
                                </div>
                            </div>
                        </form>
                        @endif
