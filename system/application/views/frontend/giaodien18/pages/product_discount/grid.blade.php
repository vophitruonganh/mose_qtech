         ...
         <div class="top-content-collection">
            <div class="col-md-2 col-xs-12 list-left-top-collection">
               <ul class="choose-layout">
                  <li class="active"><a data-layout="grid"><i class="fa fa-th"></i></a></li>
                  <li><a href="{{url('collections/discount?view=list')}}"><i class="fa fa-th-list"></i></a></li>
               </ul>
            </div>
            ...
            <div class="product-colum-3">
                @if(count($posts)!=0)
                     @foreach( $posts as $post )
                         <div class="wrap-box-padding col-md-4 col-xs-12">
                                 ...
                                 <div class="wrap-border-content-center">
                                    <a href="{{url('collections/'.$post['post_slug'])}}">
                                       <div class="list-content-center">
                                          <div class="img-product-home">
                                             <img alt="{{$post['post_title']}}" title="Điện thoại Hight Class Smart 01" src="{{loadFeatureImage($post['post_featured_image'])}}" class="img-responsive">
                                    ...
                                    <div class="price-content-center">
                                       ...
                                       <div class="wrap-addcard">
                                          ...
                                          <h4><a href="{{url('collections/'.$post['post_slug'])}}">{{$post['post_title']}}</a></h4>
                                          <span><a onclick ="order({{$post['post_id']}})">Mua ngay</a></span>
                                       </div>
                                       <!--end .wrap-addcard-->                    
                                    </div>
