...
class PostCategoryController extends BackendController
{
    private $data_arr = array(
        'section_title'=>'Danh mục bài viết',
        'tax_name'=>'danh mục',
        'tax_slug' => 'post-category',
        'tax_url' => '',
        'tax_type' => 'post_category',
        'tax_level' => '1',
        'list_view'=> array('title'=>'Tên danh mục','slug'=>'Đường dẫn','count'=>'Bài viết','excerpt'=>'Mô tả'),
