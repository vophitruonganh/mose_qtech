                                ...
                                <div class="row">
                                    <div class="col-md-4 col-sm-6">
                                        ...
                                        <div class="form-group">
                                            <a href="<?php echo e(url('customer/register')); ?>">Đăng ký tài khoản mua hàng</a>
                                            |
                                            <a href="<?php echo e(url('customer/login')); ?>">Đăng nhập </a>
                                        </div>
                                        ...
                                        <!--thông tin mua hang-->
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="email" id="email" placeholder="Email" value="<?php echo e(old('email',$email)); ?>">
                                        </div>
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="fullname" id="BillingAddress_LastName" placeholder="Họ và tên" value="<?php echo e(old('fullname',$fullname)); ?>">
                                        </div>
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="phone" id="phone" placeholder="Số điện thoại" value="<?php echo e(old('phone',$phone)); ?>">
                                        </div>
                                        <div class="form-group">
                                            <input type="text" name="address" id="BillingAddress_Address1" class="form-control" placeholder="Địa chỉ" value="<?php echo e(old('address',$address)); ?>">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="order-summary order-summary--custom-background-color ">
                                                    ...
                                                    <ul class="product-list">
                                                        ...
                                                        ?>
                                                            ...
                                                            <li class="product product-has-image clearfix">
                                                                <img src="<?php echo e(set_image_size(get_image_url($cart['variant_image']),'thumb')); ?>" alt="<?php echo e($title); ?>" class="pull-left product-image">
                                                                <div class="product-info pull-left">
                                                                    <span class="product-info-name">
                                                                    <strong><?php echo e($title); ?></strong> x <?php echo e($cart['quantity']); ?>

                                                                    </span>
                                                                    <span class="product-info-description">
                                                                    <?php echo e($cart['variant_meta']); ?>
                                            ...
                                            <div class="summary-section clearfix">
                                                ...
                                                <div class="total-line total-line-shipping clearfix" bind-show="requiresShipping">
                                                    <div class="row">
                                                        <div class="col-lg-6 total-line-name pull-left discount-title"><?php echo e($cart_meta['title']); ?></div>
                                                        <div class="col-lg-6 total-line-shipping pull-right discount-price"><span class="pull-right"><?php if($cart_meta['title']): ?>- <?php echo e(number_format($cart_meta['discount_price'], 0, ',', '.')); ?>₫ <?php endif; ?></span></div>
                                                    </div>
                                                    <!--
