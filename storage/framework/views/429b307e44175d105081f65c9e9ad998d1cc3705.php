    ...
    <div class="wrapper">
        <div class="inner space-30 section-custom-center">
            ...
            <div class="custom-center">
                <div class="grid">
                    <?php $__currentLoopData = $firstAdvertise; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                    <div class="grid__item large--one-half medium--one-half">
                        <a href="<?php echo e($row['url']); ?>" title="banner">
...
<!-- Sản Phẩm Nổi Bật -->
		<!-- Widget 1111111111 -->
			<?php echo showWidget('widget1111111111'); ?>
...
<!-- Sản Phẩm Giảm Giá -->
		<!-- Widget 2222222222 -->
			<?php echo showWidget('widget2222222222'); ?>
...
<!-- Sản Phẩm Mới -->
		<!-- Widget 3333333333 -->
			<?php echo showWidget('widget3333333333'); ?>
...
<!-- Đồ Điện Tử -->
		<!-- Widget 4444444444 -->
			<?php echo showWidget('widget4444444444'); ?>
...
<!-- Dụng Cụ Thể Hình -->
		<!-- Widget 5555555555 -->
			<?php echo showWidget('widget5555555555'); ?>
...
<!-- Thời Trang -->
		<!-- Widget 6666666666 -->
			<?php echo showWidget('widget6666666666'); ?>
...
<!-- Tin Tức -->
		<!-- Widget 7777777777 -->
			<?php echo showWidget('widget7777777777'); ?>
...
<section>
	<div class="wrapper">
		<div class="inner space-30 section-brand">
			...
			<h2  class="title"><span><img src="<?php echo e(asset('template/giaodien20/asset/images/brand_icon_title.png')); ?>" alt=''  /></span><?php echo e($doitac['heading']); ?></h2>
			<div class="brands-carousel owl-carousel owl-theme " id="brands-carousel" data-items="6" data-pagination="false" data-navigation="true" data-autoPlay="false">
				<?php unset($doitac['heading']); ?>
					...
					<a class="brand" href="<?php echo e($row['url']); ?>" title=""><img src='<?php echo e($row['image']); ?>' alt=''  /></a>
				</div>
				<?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
			</div>
		</div>
