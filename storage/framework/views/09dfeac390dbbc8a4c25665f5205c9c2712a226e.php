<table class="table table-hover">
    <thead>
        <tr>
            <th class="table-check col-1"><input type="checkbox" id="check-all" class="filled-tbl" /><label for="check-all"></label></th>
    ...
    <tr>
        ...
        <?php if($order['order_status']==4): ?>
            <td class="col-2 table-title"><?php echo e($order_code); ?></td>
        <?php else: ?>
            <td class="col-2 table-title"><a href="<?php echo e(url('admin/order/edit/'.$order['order_code'])); ?>"><?php echo e($order_code); ?></a></td>
        <?php endif; ?>
        ...
        <td class="col-5"><?php echo e(number_format($order["total"],0,',',',')); ?> ₫</td>
