<table class="table table-hover">
    ...
    <?php $i++; ?>
        <tr>
            ...
            <td class="col-2 table-title"><a href="<?php echo e(url('admin/customer/edit/'.$customer['customer_id'])); ?>"><?php if($customer['customer_fullname']): ?><?php echo e($customer['customer_fullname']); ?>

            <?php elseif($customer['customer_email']): ?><?php echo e($customer['customer_email']); ?> <?php else: ?> <?php echo e($customer['customer_id']); ?> <?php endif; ?></a></td>
            ...
            <td class="col-5 text-nowrap text-xs-center"><a href="<?php echo e(url('admin/order/edit/'.$customer['order_new'])); ?>"><?php echo e(get_template_order_code($customer['order_new'])); ?></a></td>
            <td class="col-6"><?php echo e($customer['price']); ?></td>
        </tr>
