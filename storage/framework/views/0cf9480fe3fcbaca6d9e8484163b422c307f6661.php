    ...
    <div class="container">
        ...
        <?php if($product_relateds): ?>
         <div id="like">
            ...
            <ul class="thumbnails">
               <?php $__currentLoopData = $product_relateds; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product_rel): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
               <li class="col-lg-3 col-sm-3">
                  <a class="prdocutname" href="<?php echo e(url('collections/'.$product_rel['product_slug'])); ?>" title="<?php echo e($product_rel['product_title']); ?>"><?php echo e($product_rel['product_title']); ?></a>
                  <div class="thumbnail">
                     <a href="<?php echo e(url('collections/'.$product_rel['product_slug'])); ?>" title="<?php echo e($product_rel['product_title']); ?>"><img alt="<?php echo e($product_rel['product_title']); ?>" src="<?php echo e(get_image_url($product_rel['product_image_id'])); ?>" alt="" /></a>
                     <div class="pricetag">
                        <form id="formOrder<?php echo e($product_rel['product_id']); ?>" action="<?php echo e(url('cart/order/'.$product_rel['product_slug'])); ?>" method="post">
                              <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>" />
                              <input type="hidden" name="quantity" value="1" />
                          </form>
                        <span class="spiral"></span><a onclick="order(<?php echo e($product_rel['product_id']); ?>)" class="productcart">Mua ngay</a>
                        <div class="price">
                           <div class="pricenew"><?php echo e(number_format($product_rel['price_new'],0,'.','.')); ?>&#8363;</div>
                        </div>
                     </div>
                  </div>
               </li>
