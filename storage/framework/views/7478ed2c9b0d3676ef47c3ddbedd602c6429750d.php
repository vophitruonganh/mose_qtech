<div class="menu-left" style="overflow-y: hidden;" data-plugin="jScrollPane" data-resize="true" data-type="menu-left">
    <ul class="menu-list">
        ...
        <li class="with-sub <?php echo e((Request::is('admin/order*') ? 'opened' : '')); ?>">
            <a href="javascript:;"><i class="font-icon material-icons md-20">add_shopping_cart</i><span class="lbl">Đơn hàng</span><span class="label label-danger"><?php echo e($sum_order_new); ?></span></a>
            <ul class="menu-child">
                ...
                <li><a href="<?php echo e(url('admin/order/shipment')); ?>"><span class="lbl">Vận chuyển</span></a></li>
        ...
        <li class="<?php echo e((Request::is('admin/themes*') ? 'opened' : '')); ?>">
            <a href="<?php echo e(url('admin/themes')); ?>"><i class="font-icon material-icons md-20">view_compact</i><span class="lbl">Giao diện</span></a>
        </li>
