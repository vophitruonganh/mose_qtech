<?php $__env->startSection('titlePage','Danh sách bài viết'); ?>
<?php $__env->startSection('content'); ?>
<?php 
    $heading = array(
        'heading_text' => 'Danh sách bài viết',
        'heading_button' => '<a class="btn btn-primary waves-effect" href="'.url('admin/post/create').'">Thêm mới bài viết</a>',
    );
    $setion_heading = section_title($heading);
?>
    <div class="section-post">
        <div class="form-alerts"></div>
        <form id="post-form" action="<?php echo e(url('admin/post')); ?>" method="post" data-bind="form: disable">
            ...
            <div class="box-typical">
                ...
                <div class="box-typical-body">
                    <div class="post-list data-list data-table" data-bind="load: Table.SetCheckAll">
                        <?php echo $__env->make('backend.pages.website.post.listViewPost', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                    </div>
                </div>
            </div>
        </form>
