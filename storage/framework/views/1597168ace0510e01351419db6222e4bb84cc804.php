                                          ...
                                          <div class="clearfix product-lists product-item box-product-lists mt15 clearfix" id="event-grid">
                                             <?php if(count($products)>0): ?>
                                                  <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                                    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6 mg5 product-wrapper product-resize animated zoomIn fixheight" style="height: 320px;">
                                                   ...
                                                   <div class="product-detail clearfix">
                                                      ...
                                                      <div class="product-info">
                                                         ...
                                                         <div class="product-buttons">
                                                            <div>
                                                            <form id="form_order_<?php echo e($product['product_id']); ?>" action="<?php echo e(url('cart/order/'.$product['product_slug'])); ?>" method="post" class="variants"  enctype="multipart/form-data">
                                                              <input id="page_token" type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>" />
                                                              <input type="hidden" name="quantity" value="1" />
                                                               <a class="btn-detail hidden-xs quickview" href="javascript:void(0)" data-handle="<?php echo e(url('collections/'.$product['product_slug'])); ?>" title="">
                                                               <i class="fa fa-eye"></i>
                                                               </a>
                                                               <a class="btn-addtocart" href="javascript:void(0)" onclick="order(<?php echo e($product['product_id']); ?>)" title="">Mua Ngay</a>
                                                               <a class="btn-wishlist hidden-xs" href="<?php echo e(url('collections/'.$product['product_slug'])); ?>" title="">
