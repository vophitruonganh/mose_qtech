<?php $__env->startSection('titlePage','Đăng nhập'); ?>
                    ...
                    <form action="<?php echo e(url('admin/login?ref='.$ref)); ?>" method="post" data-parsley-validate>
                        ...
                        <div class="clearfix">
                            ...
                            <div class="forgot pull-sm-right text-sm-right">
                                <div class="form-group m-b-2">
                                    <a class="btn btn-link text-muted p-a-0" href="<?php echo e(url('admin/forgot-password')); ?>"><u>Quên mật khẩu?</u></a>
                                </div>
                            </div>
                        </div>
                        <div class="clearfix">
