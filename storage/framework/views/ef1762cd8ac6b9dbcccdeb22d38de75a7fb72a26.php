         ...
         <div class="container">
            <div class="row">
               <div class="hidden-sm hidden-xs hd_top_left pull-left">
                  <img src="<?php echo e(asset('template/giaodien7/img/open.png')); ?>" alt="Raw Camera">
                  <p class="cl_old"><?php echo e($openDoor); ?></p>
               </div>
               <div class="col-md-4 col-sm-12 col-xs-12 pull-right hd_top_right">
                  <div class="search_form">
                     <form action="<?php echo e(url('collections?search='.$search)); ?>" method="get" class="search-form" role="search">
                        <input placeholder="Nhập nội dung tìm kiếm" class="form-control search_input" type="text" name="search" value="<?php echo e($search); ?>" />
         ...
         <div class="row logo_menu">
            ...
            <div class="col-lg-8 col-md-8 col-sm-8 hidden-xs account_cart">
               <div class="col-lg-5 col-md-6 col-sm-8 hidden-xs pull-right" style="padding-right:0; height: 44px;">
                  <div class="toplinks pull-left">
                     ...
                     <?php if( !Session::has('loginFrontend') ): ?>
                        <div>
                           <img src="<?php echo e(asset('template/giaodien7/img/icon-dangnhap.png')); ?>" alt="Raw Camera"/>
                     ...
                     <?php else: ?>
                        <div>
                           <img src="<?php echo e(asset('template/giaodien7/img/icon-dangnhap.png')); ?>" alt="Raw Camera"/>
                           <span class="hidden-xs">
                           <a href="<?php echo e(url('customer')); ?>" data-toggle="modal" data-target="" class="login_btn">Chỉnh sửa</a>
                           </span> 
                        </div>
                        <div>
                           <img src="<?php echo e(asset('template/giaodien7/img/icon-dangnhap.png')); ?>" alt="Raw Camera"/>
                           <span class="hidden-xs">
                           <a href="<?php echo e(url('customer/logout')); ?>" data-toggle="modal" data-target="" class="login_btn">Đăng xuất</a>
                           </span> 
                        </div>
                     <?php endif; ?>
                     </div>
                        ...
                        <div class="mini-cart pull-right">
                           <div data-toggle="dropdown" data-hover="dropdown" class="basket dropdown-toggle">
                              <a href="<?php echo e(url('cart')); ?>">
                                 <img src="<?php echo e(asset('template/giaodien7/img/icon-cart.png')); ?>" alt="Raw Camera">
                                 <div class="cart-box">
                                    <span class="title">Giỏ hàng</span>
                                    <span id="cart-total"><?php echo e($total_quantity); ?></span>
                                 </div>
                              </a>
                           </div>
                           <?php echo $xhtml; ?>
               ...
               <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 mini_menu  pull-right">
                  <?php echo navigation_menu('top_menu','hidden-sm hidden-xs','nav'); ?>
      ...
      <div class="row">
         <div class="nav-inner">
               ...
               <ul class="navmenu">
                  <li>
                     ...
                     <div class="top-cart-contain">
                        <a href="/cart">
                           <div>
                              <img src="<?php echo e(asset('template/giaodien7/img/cart-mobile.png')); ?>" alt="Raw Camera" height="20" width="20" />
                           </div>
                           <div class="cart-box">
                     ...
                     <?php echo navigation_menu('top_menu','submenu'); ?>
            ...
            <ul id="nav" class="hidden-xs" style="display: none;">
               <li class="level0 parent active"><a href="<?php echo e(url('/')); ?>"><span>Trang chủ</span></a></li>
               <li class="level0 parent "><a href="<?php echo e(url('page/gioi-thieu.html')); ?>"><span>Giới thiệu</span></a></li>
               <li class="level0 parent drop-menu ">
                  <a href="<?php echo e(url('product.html')); ?>"><span>Danh sách sản phẩm</span></a>
                  <ul class="level1">
                     <li class="level1 parent">
                        <a href="/may-anh-dslr"><span>Máy ảnh DSLR</span></a>
                        <ul class="level2 right-sub">
               ...
               <li class="level0 parent "><a href="<?php echo e(url('news.html')); ?>"><span>Tin tức</span></a></li>
               <li class="level0 parent "><a href="<?php echo e(url('contact.html')); ?>"><span>Liên hệ</span></a></li>
            </ul>
            -->
         </div>
      </div>
   ...
   <div class="modal-dialog wrap-modal-login" role="document">
      <div class="text-xs-center" id="login_popup">
         ...
         <div id="recover-password" style="display:none;" class="form-signup">
            ...
            <form accept-charset='UTF-8' action="<?php echo e(url('customer/register')); ?>" id='recover_customer_password' method='post'>
               <input id="page_token" type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>" />
