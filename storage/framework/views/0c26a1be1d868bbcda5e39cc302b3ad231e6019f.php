...
<section class="col-md-12" id="TopBar">
   <?php if( Session::has('loginFrontend') ): ?>
      <a href="<?php echo e(url('customer/logout')); ?>" class="btn btn-link pull-left btn-login">
    Logout
  </a>
   <?php else: ?>
      <a href="<?php echo e(url('customer/login')); ?>" class="btn btn-link pull-left btn-login">
        Login
      </a>
   <?php endif; ?>
  ...
  <div class="shopping-cart-widget pull-right">
    <button type="button" class="btn btn-link pull-right">
      <span aria-hidden="true" data-icon="&#xe006;"></span> <?php echo e($total_quantity); ?> items: <?php echo e(number_format($total, 0, ',', '.')); ?>₫ <b class="caret"></b>
    </button>
    <?php echo $xhtml; ?>
  ...
  <nav class="navbar navbar-default">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="<?php echo e(url('/')); ?>"><img src="<?php echo e(asset('template/decima_store/images/logo.png')); ?>" alt=" "></a>
    </div>

    <div class="navbar-collapse navbar-main-collapse" role="navigation">
      <?php echo navigation_menu('top_menu','nav navbar-nav'); ?>

      <ul class="nav navbar-nav">
        <li class="active dropdown">
          <a href="<?php echo e(url('/')); ?>" class="dropdown-toggle" data-toggle="dropdown">Trang Chủ <b class=""></b></a>
        </li>

        <li class="dropdown">
          <a href="<?php echo e(url('pages/gioi-thieu')); ?>" class="dropdown-toggle" data-toggle="dropdown">Giới thiệu <b class=""></b></a>
        </li>

        <li class="dropdown">
          <a href="<?php echo e(url('tin-chinh')); ?>" class="dropdown-toggle" data-toggle="dropdown">Tin tức<b class=""></b></a>
        </li>

        <li class="dropdown">
          <a href="<?php echo e(url('collections')); ?>" class="dropdown-toggle" data-toggle="dropdown">Sản phẩm <b class=""></b></a>
        </li>
        
        <li class="dropdown">
          <a href="<?php echo e(url('pages/contact')); ?>" class="dropdown-toggle" data-toggle="dropdown">Liên hệ <b class=""></b></a>
        </li>
        
      </ul>
      <form class="navbar-form navbar-right navbar-search" role="search" action="<?php echo e(url('collections')); ?>">
        <div class="form-group">
          <label class="sr-only" for="navbar-search">Your search</label>
          <input type="text" id="navbar-search" name="search" value="<?php echo e($search); ?>" class="form-control">
        </div>
