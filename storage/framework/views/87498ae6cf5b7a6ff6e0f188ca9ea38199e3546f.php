...
<?php 
    $heading = array(
        ...
        'heading_button' => '<a class="btn btn-primary waves-effect" href="'.url('admin/order/create').'">Thêm mới</a>',
    );
...
?>
    <div class="section-order">
        ...
        <form id="order-form" action="<?php echo e(url('admin/order')); ?>" method="post">
            ...
            <input type="hidden" id="user_id" name="user_id" value="<?php echo e($user_id); ?>"></input>
                        ...
                        <div class="pull-md-left">
                            <div class="form-group">
                                <select name="order_status" id="action_status" class="form-control" data-bind="change: Table.ActionChange, change: Table.StatusChange">
                                    ...
                                    <?php if($order_count['trash'] > 0): ?><option <?php if($order_status =='4'): ?>selected="selected" <?php endif; ?>  value="4" data-url="<?php echo e(url('admin/order?order_status=4')); ?>">Xóa<span class="count">(<?php echo e($order_count['trash']); ?>)</span></option><?php endif; ?>
                                </select>
                            </div>
                              <?php
                                $arr=array();
