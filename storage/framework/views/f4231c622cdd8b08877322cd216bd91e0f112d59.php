               ...
               <div class="toolbar">
                  <div class="sorter">
                     <div class="view-mode"> 
                        ...
                        <a href="<?php echo e(url('collections?view=list')); ?>" title="List" class=""><i class="fa fa-list"></i></a> 
                     </div>
                  </div>
                        ...
                        <div class="info">
                           <div class="info-inner">
                              <div class="item-title">
                                 <h3><a title="Xe đạp không phanh Fornix" href="<?php echo e(url('collections/'.$product['product_slug'])); ?>"><?php echo e($product['product_title']); ?></a></h3>
                              </div>
                              <!--item-title-->
