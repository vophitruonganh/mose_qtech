                                          ...
                                          <div class="col-md-12">
                                             <ul class="form-list">
                                                ...
                                                <li>
                                                   ...
                                                   <br>                
                                                   <input style="padding: 5px;width: 99%;" type="text" class="input-text" name="address" placeholder="Địa chỉ 1" value="<?php echo e(old('address', $address)); ?>" autocapitalize="words">  
                                                </li>
