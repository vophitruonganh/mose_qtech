    ...
    <table class="table">
        ...
        <?php $__currentLoopData = $variant_array; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $variant): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
            <tr data-id="<?php echo e($variant['variant_id']); ?>">
                ...
                <td class="col-2 text-xs-center"><span class="variant-thumb"><?php if($variant['image']): ?><div class="thumbnail-preview"><div class="thumbnail"><div class="centered"><img data-id="<?php echo e($variant['image']); ?>" src="<?php echo e(get_image($variant['image'],'thumb')); ?>"></div></div></div><?php else: ?><i class="font-icon material-icons md-20">photo_camera</i><?php endif; ?></span></td>
