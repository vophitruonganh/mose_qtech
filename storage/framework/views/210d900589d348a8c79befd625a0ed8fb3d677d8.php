...
<div class="main-container col2-left-layout">
   ...
   <div class="category-products">
      <div class="toolbar">
         <div class="sorter">
            <div class="view-mode"> 
               <a href="<?php echo e(url('collections?view=grid')); ?>" title="Grid" class="button-active"><i class="fa fa-th"></i></a> 
      ...
      <ol id="products-list" class="products-list">
        <?php if(count($products)>0): ?>
            <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
             <li class="item even">
                <div class="product-image"> <a href="<?php echo e(url('collections/'.$product['product_slug'])); ?>" title="<?php echo e($product['product_title']); ?>"> <img class="small-image" src="<?php echo e(get_image_url($product['product_image_id'])); ?>" width="230"> </a> </div>
                <div class="product-shop">
                   <h3 class="product-name"><a title="<?php echo e($product['product_title']); ?>" href="<?php echo e(url('collections/'.$product['product_slug'])); ?>"><?php echo e($product['product_title']); ?></a></h3>
                   <div class="desc std">
         ...
         <div class="pages">
            <ul class="pagination">
                <?php if($products->currentPage()!=1): ?>
                            <li>
                                <a href="<?php echo e(str_replace('/?','?',$products->url($products->currentPage()-1))); ?>">
                                    Trang trước
                                </a>
                            </li>
                            <?php endif; ?>
                            ...
                            <li class="<?php echo e(($products->currentPage()==$i)? 'active' : ''); ?>">
                                <a href="<?php echo e(str_replace('/?','?',$products->url($i))); ?>"><?php echo e($i); ?></a>
                            </li>
                            ...
                            <li>
                                <a class="next-arrow" href="<?php echo e(str_replace('/?','?',$products->url($products->currentPage()+1))); ?>" title="2">
                                    Trang sau
                                </a>
                            </li>
                            <?php endif; ?>
