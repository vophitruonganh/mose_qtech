    ...
    <thead>
        <tr>
            ...
            <?php if(isset($data_arr['list_view']['count'])): ?>
                <th class="col-4"><?php echo e($data_arr['list_view']['count']); ?> <a href="<?php echo e(url('admin/taxonomy/'.$data_arr['tax_slug'].'?sort=')); ?>"><i class="font-icon material-icons md-18">swap_vert</i></a></th>
            <?php endif; ?>
