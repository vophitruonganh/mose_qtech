...
?>
                ...
                <div class="box-container-1">
                    ...
                    <div class="box-typical b-t-m">
                        <div class="box-typical-body b-t-p">
                            ...
                            <div class="variant-table" data-bind="load: Variant.LoadImageModal, load: Variant.LoadEditModal, load: Variant.Delete" data-product-id="<?php echo e($post->product_id); ?>">
    ...
    <div id="modal-variant-add" class="modal fade" data-bind="load: Variant.SubmitModal" data-type="create">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="<?php echo e(url('admin/product/variant/create/'.$post->product_id)); ?>" method="post" data-bind="form: disable">
    ...
    <div id="modal-variant-image" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="<?php echo e(url('admin/product/variant/image/'.$post->product_id)); ?>" method="post" data-bind="form: disable">
