...
?>
    <div class="section-navigation">
        ...
        <form id="navigation-form" action="<?php echo e(url('admin/navigation')); ?>" method="post">
                ...
                <div class="box-typical-header box-typical-header-bordered b-t-p">
                    <div class="form-inline nav-action clearfix">
                        <div class="pull-md-left">
                             <?php echo tableActionForm('','','','click: Navigation.TableAction'); ?>

                        </div>
                        <?php echo tableSearchForm($search,'<div class="pull-md-right">','</div>','click: Navigation.TableSearch'); ?>

                    </div>
                </div>
                <div class="box-typical-body">
                    <div class="navigation-list data-list data-table">
                        <table class="table table-hover tbl-typical">
                            ...
                            <tbody>
                                ...
                                <?php else: ?>
                                    ...
                                    <tr>
                                        <th class="table-check"><input id="tbl-check-<?php echo e($i); ?>" type="checkbox" class="filled-tbl" name="check[]" id="check[]" value="<?php echo e($key); ?>" /><label for="tbl-check-<?php echo e($i); ?>"></label></th>
                                        <td class="table-title"><a href="<?php echo e(url('admin/navigation/edit/'.$key)); ?>"><?php echo e($arries['menu_name']); ?></a></td>
                                        <?php if( !in_array($key,$navigation_load) ): ?>
                                        <td class="table-title"><span class="label label-default">Chưa xác định</span></td>
                                        <?php else: ?> 
                                            <?php $keyNavigationLoad = array_search($key,$navigation_load); ?>
                                            <?php if( !isset($registerNavigation[$keyNavigationLoad]) ): ?>
                                            <td class="table-title"><span class="label label-default">Chưa xác định</span></td>
                                            <?php endif; ?>
                                            <td class="table-title"><span class="label label-success"><?php echo e($registerNavigation[$keyNavigationLoad]); ?></span></td>
                                        <?php endif; ?>
                                    </tr>
