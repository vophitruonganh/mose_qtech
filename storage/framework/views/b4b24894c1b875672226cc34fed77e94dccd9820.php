...
?>
<form method="post" action="<?php echo e(url('cart/checkout')); ?>" data-toggle="validator" class="formCheckoutOrder">
                ...
                <div class="wrap clearfix">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-6">
                            ...
                            <div class="form-group">
                                <input class="form-control" name="fullname" id="fullname" placeholder="fullname" value="<?php echo e(old('fullname',$fullname)); ?>">
                            </div>
                            <div class="form-group">
                                <input class="form-control" name="phone" id="phone" placeholder="Số điện thoại" value="<?php echo e(old('phone',$phone)); ?>">
                            </div>
                            <div class="form-group">
                                <input name="address" id="address" class="form-control" placeholder="Địa chỉ" value="<?php echo e(old('address',$address)); ?>">
                            </div>
                            <div class="form-group">
