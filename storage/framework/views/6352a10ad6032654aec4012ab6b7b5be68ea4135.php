                           ...
                           <?php if(count($list_post_image)>0): ?>
                                   <?php $__currentLoopData = $list_post_image; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $img): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                    <div class="item product-thumb">
                                       <div class="item product-thumb">
                                          <a href="javascript:void(0)" data-image="<?php echo e(get_image_url($img)); ?>" data-zoom-image="<?php echo e(asset('template/giaodien5/asset/images/thep-hinh-v_master.jpg')); ?>" class="">
                                          <img alt="Thép hình" data-image="<?php echo e(get_image_url($img)); ?>" src="<?php echo e(get_image_url($img)); ?>">
                                          </a>
                                       </div>
                                    </div>
