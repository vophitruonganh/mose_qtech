<?php $__env->startSection('titlePage','Thêm mới khách hàng'); ?>
...
?>
    <div class="section-account">
        ...
        <form id="account-form" action="<?php echo e(url('admin/customer/create')); ?>" method="post" data-bind="form: disable" data-parsley-validate>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input id="nickname" class="form-control" name="fullname" type="text" value="<?php echo e(old('fullname')); ?>" />
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="telephone">Số điện thoại</label>
                                        <input id="telephone" class="form-control" name="phone" type="text" value="<?php echo e(old('phone')); ?>" data-parsley-pattern="^[\d\+\-\.\(\)\/\s]*$" data-parsley-length="[8, 11]" data-parsley-pattern-message="Số điện thoại không hợp lệ" data-parsley-length-message="Số điện thoại không hợp lệ" data-parsley-type="integer" data-parsley-type-message="Số điện thoại không hợp lệ" data-parsley-trigger="change focusout" />
                                    </div>
                                </div>
                            </div> 
                            <div class="form-group">
                                <label for="email">Email</label>
                                <input id="email" class="form-control" name="email" type="text" value="<?php echo e(old('email')); ?>" maxlength="60" data-parsley-trigger="change focusout" data-parsley-type="email" data-parsley-type-message="Địa chỉ Email không không hợp lệ" data-parsley-maxlength="60" data-parsley-maxlength-message="Địa chỉ Email quá dài." />
                            </div>
                    ...
                    <div class="section-group-body col-lg-9">
                        <div class="box-typical b-t-p">
                            <div class="form-group">
                                ...
                                <textarea name="address" id="address" class="form-control" rows="3"><?php echo e(old('address')); ?></textarea>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select id="gender" name="gender" class="form-control">
                                            <option value="0"<?php if( !$gender): ?> selected="selected"<?php endif; ?>>— Chọn giới tính —</option>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select id="level" name="level" class="form-control">
                                            ...
                                            <?php $__currentLoopData = $customer_groups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customer_group): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                            <option <?php if($level ==$customer_group->taxonomy_id ): ?> selected <?php endif; ?> value="<?php echo e($customer_group->taxonomy_id); ?>"><?php echo e($customer_group->taxonomy_name); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
            ...
            <!-- <div class="box-typical box-typical-padding">
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input id="username" class="form-control" name="username" type="text" value="<?php echo e(old('username')); ?>"/>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="email">Email</label>
                            <input id="email" class="form-control" name="email" type="text" value="<?php echo e(old('email')); ?>"/>
                        </div>
                    </div>
                </div>   
                <div class="row">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="address">Địa chỉ</label>
                            <textarea name="address" id="address" class="form-control" cols="4" rows="2"><?php echo e(old('address')); ?></textarea>
                        </div>
                    </div>
                </div> 
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="nickname">Họ tên</label>
                            <input id="nickname" class="form-control" name="nickname" type="text" value="<?php echo e(old('nickname')); ?>"/>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="telephone">Số điện thoại</label>
                            <input id="telephone" class="form-control" name="telephone" type="text" value="<?php echo e(old('telephone')); ?>"/>
                        </div>
                    </div>
                </div>  
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select id="status" name="status" class="form-control">
                                ...
                                <option value="choise"<?php if( $status == 'choise' ): ?> selected="selected"<?php endif; ?>>— Chọn tình trạng —</option>
                ...
                <div class="">
                    ...
                    <a href="<?php echo e(url('admin/customer')); ?>" class="btn">Hủy</a>
                </div>
            </div> -->
        </form>
    </div>
