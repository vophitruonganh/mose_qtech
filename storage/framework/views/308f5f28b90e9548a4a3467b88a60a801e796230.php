                                 ...
                                 <div class="product-detail clearfix">
                                    ...
                                    <div class="actions clearfix">
                                     ...
                                     <form id="form_order_<?php echo e($i); ?>"action="<?php echo e(url('cart/order/'.$product['product_slug'])); ?>" method="post" class="variants" id="product-actions-<?php echo e($product['product_id']); ?>" enctype="multipart/form-data">
                                       ...
                                       <!-- <a class="btn-like mask-view" href="<?php echo e(url('collections/'.$product['product_slug'])); ?>" data-handle="/products/pin-sac-du-phong-10000-mah-x-mobile"><i class="fa fa-bar-chart"></i><span>Xem nhanh</span></a> -->
                                       <a class="btn-buy ajax_add_to_cart " data-variant="1004706200" onclick="order(<?php echo e($i); ?>)">
