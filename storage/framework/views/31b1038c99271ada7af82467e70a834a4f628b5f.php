<?php $__env->startSection('titlePage','Thêm mới tập tin'); ?>
...
?>
    <div class="section-attachment" data-bind="load: Attachment.Create, load: Attachment.DeleteCreatePage">
        ...
        <form id="attachment-form" class="media-upload-form" action="<?php echo e(url('admin/attachment/create')); ?>" method="post" enctype="multipart/form-data">
            ...
            <script type="text/javascript">
                var domain = "<?php echo e(str_replace('/','\/',url('/'))); ?>";
