...
<div id="page" class="page template-about-us wrapper">
   <div class="banner-page">
      <img src="<?php echo e($background_page[$key]['image']); ?>" alt="Giới thiệu">
   </div>
   <div class="fix-width">
      <header class="page-header">
         <h1 class="page-title wow fadeInUp" style="visibility: visible; animation-name: none;"><?php echo e($page->post_title); ?></h1>
      </header>
      <div class="style-three-colum">
         <div class="intro-content wow fadeInUp" style="visibility: visible; animation-name: none;"><?php echo preg_replace('/<script\b[^>]*>(.*?)<\/script>/is', "", $page->post_content); ?></div>
