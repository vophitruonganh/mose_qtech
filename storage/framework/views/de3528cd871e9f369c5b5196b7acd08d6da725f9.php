...
<div class="header">
    <div class="container-fluid">
        <div class="logo">
            ...
            <a class="navbar-logo" href="<?php echo e(url('/admin')); ?>"><img src="<?php echo e($cdn_domain_image); ?>/logo.png" /></a>
            <a class="view-front" href="<?php echo e(url('/')); ?>" target="_blank"><i class="font-icon material-icons md-20">exit_to_app</i></a>
        </div>
				...
				<div class="header-shown">
					...
					<div class="dropdown user-menu">
                        <button class="dropdown-toggle" id="dd-user-menu" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <span class="img-name"><?php echo e($firstCharacter); ?></span>
                            <span class="name"><?php echo e($nickname); ?></span>
                        </button>
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dd-user-menu">
		       				<!-- <div class="dropdown-item role">Nhân viên</div>
                            <div class="dropdown-divider"></div> -->
                        	<a class="dropdown-item" target="_blank" href="<?php echo e(url('/')); ?>">Trang chủ website</a>
                            <a class="dropdown-item" href="<?php echo e(url('admin/user/edit/'.$userData->user_id)); ?>">Thay đổi thông tin</a>
                            <div class="dropdown-divider"></div>
                            ...
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item" href="<?php echo e(url('/admin/logout')); ?>">Đăng xuất</a>
                        </div>
                    </div>
				</div>
...
<?php echo $__env->make('backend.includes.left', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<div class="page-wrap">
<div class="page-content">
<?php echo $setion_heading; ?>
