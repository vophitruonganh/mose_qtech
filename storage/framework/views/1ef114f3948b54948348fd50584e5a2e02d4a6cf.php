            ...
            <div class="container">
               <div class="row">
                  ...
                  <div class="col-lg-3 contact col-sm-6">
                     ...
                     <ul>
                        <li class="phone"> <?php echo e($storeSetting['telephone']); ?> </li>
                        <li class="mobile"><?php echo e($storeSetting['telephone']); ?></li>
                        <li class="email"> <a href="mailto:<?php echo e($storeSetting['email']); ?>"><?php echo e($storeSetting['email']); ?></a></li>
                        <li class="email"> <a href="<?php echo e($url_website['url']); ?>" target="_blank"><?php echo e($url_website['url']); ?></a></li>
                     </ul>
                  </div>
