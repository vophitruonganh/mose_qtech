      ...
      <html class="no-js ie8 oldie" lang="en">
         ...
         <html lang="en">
            ...
            <head>
               ...
               <link rel="shortcut icon" href="<?php echo e($favicon); ?>" type="image/png" />
               <meta charset="utf-8" />
               <!--[if IE]>
               ...
               <!---------------- Javascript ----------------->
               <script src="<?php echo e(asset('template/giaodien6/asset/js/jquery.min.1.11.0.js')); ?>"></script>
               ...
               <link href="<?php echo e(asset('template/giaodien6/asset/css/bootstrap.min.css')); ?>" rel='stylesheet' type='text/css'  media='all'  />
               <link href="<?php echo e(asset('template/giaodien6/asset/css/font-awesome.min.css')); ?>" rel='stylesheet' type='text/css'  media='all'  />
               <link href="<?php echo e(asset('template/giaodien6/asset/css/jquery.mthumbnailscroller.css')); ?>" rel='stylesheet' type='text/css'  media='all'  />
               <!---------------- Icon Svg ----------------->
               ...
               <link href="<?php echo e(asset('template/giaodien6/asset/css/checkout.css')); ?>" rel='stylesheet' type='text/css'  media='all'  />
               <link href="<?php echo e(asset('template/giaodien6/asset/css/style.css')); ?>" rel='stylesheet' type='text/css'  media='all'  />
               <!-- CSS Responsive -->
               <link href="<?php echo e(asset('template/giaodien6/asset/css/media.css')); ?>" rel='stylesheet' type='text/css'  media='all'  />
            </head>
            <div id="fb-root"></div>
