				...
				<div class="static-contain">
					...
					<form accept-charset="UTF-8" action="<?php echo e(url('pages/contact')); ?>" id="contact" method="post">
						...
						<fieldset>
							...
							<div class="customer-name">
								<div class="input-box">
									...
									<br>
									<input type="text" size="35" class="input-text" value="<?php echo e(old('name')); ?>" name="name">
								</div>
								<div class="input-box">
									<label>Email <span class="required">*</span> </label>
									<br>                          
									<input type="email" size="35" id="email" value="<?php echo e(old('email')); ?>" class="input-text" name="email">
								</div>
								<div class="input-box">
									<label>Số điện thoại<span class="required"></span></label>
									<br>
									<input type="text" size="35" class="input-text" value="<?php echo e(old('phone')); ?>" name="phone">
								</div>
							</div>
						...
						<div style="float:none" class="">
							<textarea name="message" id="comment" title="Nội dung" class="input-text" cols="150" rows="3"><?php echo e(old('message')); ?></textarea>                        
						</div>
