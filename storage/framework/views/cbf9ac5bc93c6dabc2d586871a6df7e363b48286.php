                              ...
                              <div class="container">
                                 <div class="row">
                                       ...
                                       <div id="surround">
                                          <div class="row">
                                             <div class="col-lg-10 col-md-12 col-sm-12 col-xs-12 box-image-featured pd5">
                                                <!--
                                                <img class="product-image-feature" style="display:none" src="<?php echo e(asset('template/giaodien6/asset/images/1446785237503_8851437_1024x1024.jpg')); ?>" alt="Tivi LED Samsung 40 inch UA40J5000AKXXV">
                                                -->
                                                <img class="product-image-feature" style="display:none" src="<?php echo e($featureImage); ?>" alt="<?php echo e($title); ?>">
                                                      ...
                                                      <?php if( count($list_post_image) > 0 ): ?>
                                                           <?php $__currentLoopData = $list_post_image; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $img): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                                               <li class="product-thumb 1446785237503">
                                                                  <a href="javascript:void(0);" data-image="<?php echo e(get_image_url($img)); ?>">
                                                                  <img src="<?php echo e(get_image_url($img)); ?>" />
                                                                  </a>
                                                               </li>
                                    ...
                                    <div class="col-lg-5 col-md-7 col-sm-12 col-xs-12 pd5 information-product">
                                       ...
                                       <form id="add-item-form" action="<?php echo e(url('cart/order/'.$slug)); ?>" method="post" class="variants clearfix variant-style">
                                       ...
                                       <div class="information-more">
                                          <strong><?php echo e($information_more['heading']); ?></strong>
                                          <ul>
                                             ...
                                             <li><i class="fa fa-check"></i> <?php echo e($row['text']); ?></li>
                                             <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
                                          </ul>
                                       </div>
                                       ...
                                       <div class="product-comment">
                                          ...
                                          <div id="description">
                                             <div class="container-fluid product-description-wrapper">
                                                <p class="col-md-12"><?php echo $content; ?></p>
                                             </div>
                                          </div>
                                          <div id="comment">
                                                            ...
                                                            <div class="product-information">
                                                               <div class="product-detail">
                                                                  <div class="product-image image-resize">
                                                                     ...
                                                                     <img class="respon-owlCarousel" src="<?php echo e(get_image_url($product['product_image_id'])); ?>" alt="Internet TV LED Sony 32 inch 32W600D" />
                                                                     </a>  
                                                                  ...
                                                                  <div class="product-buttons">
                                                                     <div>
                                                                        ...
                                                                        <a class="btn-addtocart" href="javascript:void(0)" onclick="order(<?php echo e($product['product_id']); ?>)" title="">Mua Ngay</a>
                                 ...
                                 var selectCallback = function(variant, selector) {
                                 	if (variant && variant.available) {
                                 		...
                                 		if(variant.price < variant.compare_at_price){
                                 			jQuery('#price-preview').html("<span>" + Haravan.formatMoney(variant.price, "<?php echo e($priceNew); ?>₫") + "</span><del>" + Haravan.formatMoney(variant.compare_at_price, "<?php echo e($priceNew); ?>₫") + "</del>");
