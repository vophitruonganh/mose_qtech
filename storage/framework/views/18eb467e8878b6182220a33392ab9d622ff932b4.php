...
<div id="page" class="page template-contact-us wrapper">
   <div class="banner-page">
      <img src="<?php echo e($background_page[$key]['image']); ?>" alt="Liên Hệ">
   </div>
   <div class="fix-width">
               ...
               <div class="content-form">
                  <div class="apart clear">
                     <p>
                        ...
                        <input type="text" id="contactFormName" name="name" value="<?php echo e(old('name')); ?>">
                     </p>
                     <p>
                        <label for="contactFormEmail">Email</label>
                        <input type="email" id="contactFormEmail" name="email" value="<?php echo e(old('email')); ?>">
                     </p>
                     <p>
                        <label for="contactFormTelephone">Điện thoại</label>
                        <input type="telephone" id="contactFormTelephone" name="phone" value="<?php echo e(old('phone')); ?>">
                     </p>
                  </div>
                  <div class="apart clear">
                     <p class="request">
                        <label for="contactFormMessage">Nội dung</label>
                        <textarea rows="15" cols="75" id="contactFormMessage" name="message"><?php echo e(old('message')); ?></textarea>
                     </p>
                     <p class="submit"> 
