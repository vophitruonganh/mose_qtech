                    ...
                    <div class="wrap clearfix">
                        <div class="row">
                            <div class="col-md-4 col-sm-6">
                                ...
                                <div class="form-group">
                                    <input class="form-control" name="fullname" id="BillingAddress_LastName" placeholder="Họ và tên" value="<?php echo e(old('fullname',$fullname)); ?>">
                                </div>
                                <div class="form-group">
                                    <input class="form-control" name="phone" id="BillingAddress_Phone" placeholder="Số điện thoại" value="<?php echo e(old('phone', $phone)); ?>" />
                                </div>
                                <div class="form-group">
                                    <input name="address" id="BillingAddress_Address1" class="form-control" placeholder="Địa chỉ" value="<?php echo e(old('address')); ?>" />
                                </div>
                                <div class="form-group">
                                ...
                                <div class="order-summary order-summary--custom-background-color ">
                                    ...
                                    <div class="summary-section">
                                        ...
                                        <div class="total-line total-line-total">
                                            ...
                                            <span class="total-line-price pull-right total-price"><?php echo e(number_format($total_temp, 0, ',', '.')); ?>₫</span>
                                        </div>
                                    </div>
                                </div>
    ...
    function change_code(){
        ...
        $.ajax({
            ...
            success: function(data){
                ...
                $('span.total-price').html(data.total+'đ');
