...
<div id="maincontainer">
    <div class="container">
        <ul class="breadcrumb">
            ...
            <li><a href="<?php echo e(url('tin-chinh')); ?>" target="_self">Tin tức</a> </li>
            ...
            <div class="col-lg-9">
                ...
                <section id="latestblog">
                    <div class="blogdetail">
                        <h2 class="heading2"><span><?php echo e($post->post_title); ?></span></h2>
                        <div class="blogicons">
                            <div class="pull-left">
                                <span class="mr10"><i class="fa-calendar"></i><?php echo e(date('d-m-Y',$post->post_date)); ?></span>
                                <!-- <span class="mr10"><a href="#"><i class="fa-comment"></i> 0<span> Bình luận</span> </a></span> -->
                                <?php if($post->comment_status=='yes'): ?>
                                    <i class="fa-comment"></i><span class="fb-comments-count" data-href="<?php echo e(url($post->post_slug)); ?>"></span> nhận xét
                                    <span class="mr10">
                                <?php endif; ?>
                        ...
                        <ul class="margin-none">
                            <li class="listblcok">
                                <div class="caption">
                                    ...
                                    <div class="author" align="right">Người đăng: <a href="#"><?php echo e((!empty($post->user_fullname)) ? $post->user_fullname : $post->user_email); ?></a>
                                    </div>
                                </div>
                            </li>
                        </ul>
                        <!-- Comment face-->
                        <?php if($post->comment_status=='yes'): ?>
                                <div class="fb-comments" data-href="<?php echo e(url($post->post_slug)); ?>" data-numposts="3"></div>
                                <div class="clear"></div>
                        <?php endif; ?>
