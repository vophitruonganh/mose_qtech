         ...
         <div class="row" id="cart">
            <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 pd5">
               ...
               <input id="page_token" type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>" />
                  ...
                  <div class="clearfix">
                     <a class="continue-shopping" title="Mua tiếp" href="<?php echo e(url('collections')); ?>">Mua tiếp</a>
            ...
            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 pd5">
               ...
               <div class="right-cart">
                  <h2>
                     ...
                     <label><?php echo e(number_format($total, 0, ',', '.')); ?>₫</label>
                  </h2>
                  <a class="checkout" onclick="window.location= '<?php echo e(url('cart/checkout')); ?>'">
                  Thanh toán
                  </a>
               </div>
