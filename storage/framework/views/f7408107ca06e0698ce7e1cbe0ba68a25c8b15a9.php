...
<div class="menu-left" style="overflow-y: hidden;" data-plugin="jScrollPane" data-resize="true" data-type="menu-left">
    ...
    <?php $__env->startSection('sitebar-store'); ?>
        ...
        <li class="with-sub <?php echo e(((Request::is('admin/product*') || Request::is('admin/group-product*') || Request::is('admin/manufactory-product*') || Request::is('admin/taxonomy/product-*') ) ? 'opened' : '')); ?>">
            <a href="javascript:;">
                <i class="font-icon material-icons md-20">shopping_cart</i>
        ...
        <li class="with-sub <?php echo e((Request::is('admin/order*') ? 'opened' : '')); ?>">
            <a href="javascript:;">
                <i class="font-icon material-icons md-20">add_shopping_cart</i>
        ...
        <li class="<?php echo e((Request::is('admin/discount*') ? 'opened' : '')); ?>">
            <a href="<?php echo e(url('admin/discount')); ?>">
                <i class="font-icon material-icons md-20">card_giftcard</i>
        ...
        <li class="with-sub <?php echo e((Request::is('admin/customer*')  || Request::is('admin/taxonomy/customer-group*') ? 'opened' : '')); ?>">
            <a href="javascript:;">
                <i class="font-icon material-icons md-20">accessibility</i>
    ...
    <?php $__env->startSection('sitebar-website'); ?>
        ...
        <li class="<?php echo e((Request::is('admin/page*') ? 'opened' : '')); ?>">
            <a href="<?php echo e(url('admin/page')); ?>">
                <i class="font-icon material-icons md-20">description</i>
        ...
        <li class="<?php echo e((Request::is('admin/navigation*') ? 'opened' : '')); ?>">
            <a href="<?php echo e(url('admin/navigation')); ?>">
                <i class="font-icon material-icons md-20">dvr</i>
                <span class="lbl">Menu</span>
            </a>
        </li>
        <?php endif; ?>
        <li class="<?php echo e((Request::is('admin/widget*') ? 'opened' : '')); ?>">
            <a href="<?php echo e(url('admin/widget')); ?>">
                <i class="font-icon material-icons md-20">widgets</i>
                <span class="lbl">Tiện ích</span>
            </a>
        </li>
        <li class="<?php echo e((Request::is('admin/template*') ? 'opened' : '')); ?>">
            <a href="<?php echo e(url('admin/template')); ?>">
                <i class="font-icon material-icons md-20">view_compact</i>
                <span class="lbl">Giao diện</span>
            </a>
        </li>
        <li class="<?php echo e((Request::is('admin/setting/website') ? 'opened' : '')); ?>">
            <a href="<?php echo e(url('admin/setting/website')); ?>">
                <i class="font-icon material-icons md-20">settings</i>
                <span class="lbl">Thiết lập</span>
            </a>
        </li>
        <li class="<?php echo e((Request::is('admin/setting/domains') ? 'opened' : '')); ?>">
            <a href="<?php echo e(url('admin/setting/domains')); ?>">
                <i class="font-icon material-icons md-20">domain</i>
                <span class="lbl">Tên miền</span>
            </a>
        </li>
    <?php echo $__env->yieldSection(); ?>
    ...
    <?php $__env->startSection('sitebar-setting'); ?>

        <li class="menu-border">Setting</li>
