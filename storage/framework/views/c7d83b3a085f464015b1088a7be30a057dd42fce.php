<?php $__env->startSection('titlePage','Thêm mới bài viết'); ?>
...
?>
    <div class="section-post">
		...
		<form action="<?php echo e(url('admin/post/create')); ?>" method="post" data-bind="form: disable">
                ...
                <div class="box-container-1">
                    <div class="box-typical b-t-p b-t-m">
                        ...
                        <div class="form-group m-b-0">
                            <label>Mô tả</label>
                            <textarea class="form-control meta-description" rows="3" name="excerpt"><?php echo e(old('excerpt')); ?></textarea>
                    ...
                    <div class="box-typical">
                        <div class="proj-page-section proj-page-action clearfix">
                            <div class="pull-xs-right">
                                <a class="btn btn-link" href="<?php echo e(url('admin/post/')); ?>">Hủy</a>
                        ...
                        <div class="proj-page-section">
                            ...
                            <div id="post-tags" class="tags-choose">
                                <div class="form-group">
                                    <input type="text" name="newtags" data-plugin="tagsinput" class="form-control" value="<?php echo e(old('tag_name')); ?>" placeholder="Nhập nhãn bài viết" />
                                </div>
                            </div>
                        </div>
                        <div class="proj-page-section">
