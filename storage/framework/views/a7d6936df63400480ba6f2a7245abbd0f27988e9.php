...
<header>
            ...
            <div class="col-lg-12">
               <div class="logo pull-left">
                  ...
                  <h1>
                     ...
                     <img src="<?php echo e(isset($logo_main['image']) ? $logo_main['image'] : ''); ?>" alt="" class="img-responsive"/>
                     </a>
                  </h1>
               ...
               <div class="pull-left">
                  <div class="navbar" id="topnav">
                     <div class="navbar-inner">
                        <ul class="nav" >
                           <li><a class="home active" href="<?php echo e(url('/')); ?>">Trang chủ</a> </li>
                          
                           <?php if( Session::has('loginFrontend') ): ?>
                            <li><a class="myaccount" href="<?php echo e(url('customer')); ?>">Chỉnh sửa</a></li>
                            <li><a class="myaccount" href="<?php echo e(url('customer/logout')); ?>">Thoát</a></li>
                           <?php else: ?>
                           <li><a class="myaccount" href="<?php echo e(url('customer/login')); ?>">Đăng nhập</a> </li>
                           <li><a class="my-register" href="<?php echo e(url('customer/register')); ?>"><i class="fa fa-key"></i>Đăng ký</a></li>
                           <?php endif; ?>
                        </ul>
                     </div>
                  </div>
               ...
               <div class="pull-right">
                  <form class="form-search top-search" action="<?php echo e(url('collections')); ?>" method="get">
                     <!--<input type="hidden" name="type" value="product" />-->
                     <input type="text" name="search" value="<?php echo e($search); ?>" class="input-medium search-search" placeholder="Tìm kiếm …">
                  </form>
               </div>
            </div>
         </div>
   ...
   <div class="container">
      <div class="headerdetails">
         <div class="pull-right">
            ...
            <li class="dropdown hover carticon ">
                  <a href="<?php echo e(url('cart')); ?>" class="dropdown-toggle" > Giỏ hàng <span class="label label-orange font14"><?php echo e($total_quantity); ?> (sản phẩm)</span> - <?php echo e(number_format($total, 0, ',', '.')); ?>₫ <b class="caret"></b></a>
      ...
      <div id="categorymenu">
         <nav class="subnav">
            <?php echo navigation_menu('top_menu','nav-pills categorymenu'); ?>
