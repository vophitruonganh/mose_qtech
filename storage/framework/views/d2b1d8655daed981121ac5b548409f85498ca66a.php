<?php 
 ...
 ?>
  <body id="<?php echo e($idBody); ?>">
      <div class="wrapper">
         <div class="header">
            <div class="container">
               <div class="row">
                  <div class="col-md-2 col-sm-2">
                     <div class="logo"><a href="index.html"><img src="<?php echo e(asset('template/shop/asset/images/logo.png')); ?>" alt="FlatShop"></a></div>
                  </div>
                  <div class="col-md-10 col-sm-10">
					<!-- header top -->
					<?php echo $__env->make('frontend.shop.teamplates.header_top', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
					<!-- end header top-->
                     ...
                     <div class="header_bottom">
                        ...
                        <!-- menu -->
                        <?php echo $__env->make('frontend.shop.teamplates.navigation', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
						      <!-- end menu-->
                     </div>
                  </div>
               </div>
