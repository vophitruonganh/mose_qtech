...
?>
    <div class="section-order order-create">
        ...
        <form action="<?php echo e(url('admin/order/craete')); ?>" method="post">
                ...
                <div class="box-container-1">
                    <div class="box-typical">
                        ...
                        <div class="box-typical-body b-t-p">
                            <div class="product-table m-b-1" data-bind="">
                                <table class="table">
                                    <tbody>
                                        <tr>
                                            <td class="col-1">
                                                <div class="product-thumb">
                                                    <div class="thumbnail-preview"><div class="thumbnail"><div class="centered"><img src="http://mosecdn.com/1/1/uploads/2016/11/rfb_2013ipadmini_wifi_gray.jpg" alt="" /></div>
                                                </div>
                                            </td>
                                            <td class="">
                                                <a class="product-name" href="<?php echo e(url('admin/product/edit/')); ?>">Apple iPhone 5C 32GB (Hồng)</a>
                                                <p class="variant-name m-a-0">Default Title</p>
                                            </td>
                                            <td class="col-3 text-nowrap">
                                                <div class="product-price-group"><span class="product-price text-inline-hidden">5,500,000</span> <span class="currency-symbols" data-type="VND">&#8363;</span></div>
                                            </td>
                                            <td class="col-4 text-xs-center">x</td>
                                            <td class="col-5"><div class=""><input class="form-control" type="text" min="1" data-bind="" value="1" /></div></td>
                                            <td class="col-6"><button type="button" class="btn btn-link btn-remove p-a-0"><i class="material-icons md-20">close</i></td>
                                        </tr>
                                        <tr>
                                            <td class="col-1">
                                                <div class="product-thumb">
                            ...
                            <div class="form-group order-money-main font-lg-size">
                                ...
                                <ul class="order-discount">
                                    <li><span class="discount-title">Chương trình khuyến mãi:</span> <span class="discount-name font-weight-bold">Khai trương cửa hàng mới</span><button type="button" class="close" data-bind="click: Store.OrderRemoveDiscount"><span aria-hidden="true">&times;</span></button></li>
                                    <li><span class="discount-title">Mã khuyến mãi:</span> <span class="discount-name font-weight-bold">TRWIH3YHVH5A</span><button type="button" class="close" data-bind="click: Store.OrderRemoveDiscount"><span aria-hidden="true">&times;</span></button></li>
                                </ul>
                            ...
                            <div class="clearfix">
                                <div class="pull-xs-right">
                                    <button type="submit" class="btn btn-secondary waves-effect" data-type="draft" data-bind="click: Order.OrderAdd">Lưu nháp</button>
                                    <button type="submit" class="btn btn-primary waves-effect" data-type="pending" data-bind="click: Order.OrderAdd">Thanh toán sau</button>
                                    <button type="submit" class="btn btn-success waves-effect" data-type="paid" data-bind="click: Order.OrderAdd">Đã thanh toán</button>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="price_new" value="" />
