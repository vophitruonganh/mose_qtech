...
//				 if (view == 'list') {
//
//					 jQuery('.product_list').removeClass('grid').addClass('list');
//					 jQuery('.product_list').find('.ajax_block_product').removeClass('col-sm-4 col-md-3');
...
//				 } else {
//					 jQuery('.product_list').removeClass('list').addClass('grid');
//					 jQuery('.product_list').find('.ajax_block_product').addClass('col-sm-4 col-md-3');
