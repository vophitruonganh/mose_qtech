...
$(document).ready(function() {
  ...
  $('body').on('mouseenter','.swatch-element', function(){
    ...
    if ( image && typeof image != 'undefined' ) {
      $(this).parent().parent().parent().find('.product-thumbnail img.back-img').attr('src', image);
    }
    return true;
  });
  ...
  $('.product-single .swatch-element.color').click(function(){
    var image = $(this).data('image');
    if ( image && typeof image != 'undefined' ) {
      $('.product-single').find('.product-single__photos img').attr('src', image);
      $('.product-single').find('a.cloud-zoom').attr('href', image);
    }
    return true;
  });
