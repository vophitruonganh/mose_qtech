...
//    $modalContainer.prepend('<button type="button" class="ajaxcart__close" title="' + 'Đóng' + '">' + 'Đóng' + '</button>');
...
//    if (cart.item_count === 0) {
//      $cartContainer
//        .append('<h2>' + 'Không có sản phẩm nào trong giỏ hàng của bạn.' + '</h2>')
//        .append('<p class="text-center">' + 'Tiếp tục mua sắm <a href="/collections/all">Tại đây</a>.' + '</p>');
//
//      switch (settings.method) {
//        case 'modal':
//          sizeModal('resize');
...
//          $cartContainer.prepend('<button type="button" class="ajaxcart__close" title="' + 'Đóng' + '">' + 'Đóng' + '</button>');
//          $closeCart = $('.ajaxcart__close');
